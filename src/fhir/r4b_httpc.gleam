  ...
  case httpc.send(req) {
    ...
    Ok(resp) ->
      case r4b_sansio.any_resp(resp, res_dec) {
        ...
        Error(r4b_sansio.ErrDecode(dec_err)) -> Error(ReqErrDecode(dec_err))
        Error(r4b_sansio.ErrNoId) -> Error(ReqErrNoId)
      }
  }
}
...
pub fn domainresource_create(
  ...
  client: FhirClient,
) -> Result(r4b.Domainresource, ReqError) {
  any_create(
    r4b.domainresource_to_json(resource),
    "DomainResource",
    r4b.domainresource_decoder(),
    client,
  )
}
...
pub fn domainresource_read(
  ...
  any_read(id, client, "DomainResource", r4b.domainresource_decoder())
}
...
pub fn parameters_create(
  ...
  client: FhirClient,
) -> Result(r4b.Parameters, ReqError) {
  any_create(
    r4b.parameters_to_json(resource),
    "Parameters",
    r4b.parameters_decoder(),
    client,
  )
}
...
pub fn parameters_read(
  ...
  any_read(id, client, "Parameters", r4b.parameters_decoder())
}
