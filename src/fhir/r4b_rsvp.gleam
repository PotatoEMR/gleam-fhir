...
/// `let read_pat_effect = r4b_rsvp.patient_read("123", client, msg)`
///
/// create client from server base url with fhirclient_new(baseurl)`
///
/// `let assert Ok(client) = r4b_rsvp.fhirclient_new("r4.smarthealthit.org/")`
///
/// `let assert Ok(client) = r4b_rsvp.fhirclient_new("https://r4.smarthealthit.org/")`
///
/// `let assert Ok(client) = r4b_rsvp.fhirclient_new("https://hapi.fhir.org/baseR4")`
///
/// `let assert Ok(client) = r4b_rsvp.fhirclient_new("127.0.0.1:8000")`
pub type FhirClient =
...
pub type Err {
  ...
  ErrSansio(err: r4b_sansio.ErrResp)
}
...
fn any_delete(
  ...
  res_type: String,
  client: FhirClient,
  handle_response: fn(Result(r4b_sansio.OperationoutcomeOrHTTP, Err)) -> a,
) -> Effect(a) {
...
pub fn search_any(
  ...
  res_type: String,
  client: FhirClient,
  handle_response: fn(Result(r4b.Bundle, Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.any_search_req(search_string, res_type, client)
  sendreq_handleresponse(req, r4b.bundle_decoder(), "Bundle", handle_response)
}
...
fn sendreq_handleresponse_andprocess(
  ...
  let handle_read = fn(resp_res: Result(Response(String), rsvp.Error)) {
    handle_response(case resp_res {
      Error(err) -> Error(ErrRsvp(err))
      Ok(resp_res) -> {
        case r4b_sansio.any_resp(resp_res, res_dec, res_type) {
...
pub fn account_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Account, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn account_search_bundled(
  ...
  response_msg handle_response: fn(Result(r4b.Bundle, Err)) -> msg,
) -> Effect(msg) {
...
pub fn account_search(
  search_for search_args: r4b_sansio.SpAccount,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Account), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.account_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn activitydefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Activitydefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn activitydefinition_search(
  search_for search_args: r4b_sansio.SpActivitydefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Activitydefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.activitydefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn administrableproductdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Administrableproductdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn adverseevent_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Adverseevent, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn adverseevent_search(
  search_for search_args: r4b_sansio.SpAdverseevent,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Adverseevent), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.adverseevent_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn allergyintolerance_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Allergyintolerance, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn allergyintolerance_search(
  search_for search_args: r4b_sansio.SpAllergyintolerance,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Allergyintolerance), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.allergyintolerance_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn appointment_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Appointment, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn appointment_search(
  search_for search_args: r4b_sansio.SpAppointment,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Appointment), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.appointment_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn appointmentresponse_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Appointmentresponse, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn appointmentresponse_search(
  search_for search_args: r4b_sansio.SpAppointmentresponse,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Appointmentresponse), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.appointmentresponse_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn auditevent_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Auditevent, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn auditevent_search(
  search_for search_args: r4b_sansio.SpAuditevent,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Auditevent), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.auditevent_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn basic_create(
  resource: r4b.Basic,
  client: FhirClient,
  handle_response: fn(Result(r4b.Basic, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn basic_search(
  search_for search_args: r4b_sansio.SpBasic,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Basic), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.basic_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn binary_create(
  resource: r4b.Binary,
  client: FhirClient,
  handle_response: fn(Result(r4b.Binary, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn binary_search(
  search_for search_args: r4b_sansio.SpBinary,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Binary), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.binary_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn biologicallyderivedproduct_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Biologicallyderivedproduct, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn bodystructure_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Bodystructure, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn bodystructure_search(
  search_for search_args: r4b_sansio.SpBodystructure,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Bodystructure), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.bodystructure_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn bundle_create(
  resource: r4b.Bundle,
  client: FhirClient,
  handle_response: fn(Result(r4b.Bundle, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn bundle_search(
  search_for search_args: r4b_sansio.SpBundle,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Bundle), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.bundle_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn capabilitystatement_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Capabilitystatement, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn capabilitystatement_search(
  search_for search_args: r4b_sansio.SpCapabilitystatement,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Capabilitystatement), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.capabilitystatement_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn careplan_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Careplan, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn careplan_search(
  search_for search_args: r4b_sansio.SpCareplan,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Careplan), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.careplan_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn careteam_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Careteam, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn careteam_search(
  search_for search_args: r4b_sansio.SpCareteam,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Careteam), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.careteam_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn catalogentry_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Catalogentry, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn catalogentry_search(
  search_for search_args: r4b_sansio.SpCatalogentry,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Catalogentry), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.catalogentry_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn chargeitem_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Chargeitem, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn chargeitem_search(
  search_for search_args: r4b_sansio.SpChargeitem,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Chargeitem), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.chargeitem_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn chargeitemdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Chargeitemdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn chargeitemdefinition_search(
  search_for search_args: r4b_sansio.SpChargeitemdefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Chargeitemdefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.chargeitemdefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn citation_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Citation, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn citation_search(
  search_for search_args: r4b_sansio.SpCitation,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Citation), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.citation_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn claim_create(
  resource: r4b.Claim,
  client: FhirClient,
  handle_response: fn(Result(r4b.Claim, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn claim_search(
  search_for search_args: r4b_sansio.SpClaim,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Claim), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.claim_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn claimresponse_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Claimresponse, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn claimresponse_search(
  search_for search_args: r4b_sansio.SpClaimresponse,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Claimresponse), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.claimresponse_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn clinicalimpression_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Clinicalimpression, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn clinicalimpression_search(
  search_for search_args: r4b_sansio.SpClinicalimpression,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Clinicalimpression), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.clinicalimpression_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn clinicalusedefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Clinicalusedefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn clinicalusedefinition_search(
  search_for search_args: r4b_sansio.SpClinicalusedefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Clinicalusedefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.clinicalusedefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn codesystem_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Codesystem, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn codesystem_search(
  search_for search_args: r4b_sansio.SpCodesystem,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Codesystem), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.codesystem_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn communication_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Communication, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn communication_search(
  search_for search_args: r4b_sansio.SpCommunication,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Communication), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.communication_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn communicationrequest_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Communicationrequest, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn communicationrequest_search(
  search_for search_args: r4b_sansio.SpCommunicationrequest,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Communicationrequest), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.communicationrequest_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn compartmentdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Compartmentdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn compartmentdefinition_search(
  search_for search_args: r4b_sansio.SpCompartmentdefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Compartmentdefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.compartmentdefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn composition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Composition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn composition_search(
  search_for search_args: r4b_sansio.SpComposition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Composition), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.composition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn conceptmap_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Conceptmap, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn conceptmap_search(
  search_for search_args: r4b_sansio.SpConceptmap,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Conceptmap), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.conceptmap_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn condition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Condition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn condition_search(
  search_for search_args: r4b_sansio.SpCondition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Condition), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.condition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn consent_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Consent, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn consent_search(
  search_for search_args: r4b_sansio.SpConsent,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Consent), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.consent_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn contract_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Contract, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn contract_search(
  search_for search_args: r4b_sansio.SpContract,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Contract), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.contract_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn coverage_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Coverage, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn coverage_search(
  search_for search_args: r4b_sansio.SpCoverage,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Coverage), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.coverage_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn coverageeligibilityrequest_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Coverageeligibilityrequest, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn coverageeligibilityresponse_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Coverageeligibilityresponse, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn detectedissue_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Detectedissue, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn detectedissue_search(
  search_for search_args: r4b_sansio.SpDetectedissue,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Detectedissue), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.detectedissue_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn device_create(
  resource: r4b.Device,
  client: FhirClient,
  handle_response: fn(Result(r4b.Device, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn device_search(
  search_for search_args: r4b_sansio.SpDevice,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Device), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.device_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn devicedefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Devicedefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn devicedefinition_search(
  search_for search_args: r4b_sansio.SpDevicedefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Devicedefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.devicedefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn devicemetric_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Devicemetric, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn devicemetric_search(
  search_for search_args: r4b_sansio.SpDevicemetric,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Devicemetric), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.devicemetric_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn devicerequest_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Devicerequest, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn devicerequest_search(
  search_for search_args: r4b_sansio.SpDevicerequest,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Devicerequest), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.devicerequest_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn deviceusestatement_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Deviceusestatement, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn deviceusestatement_search(
  search_for search_args: r4b_sansio.SpDeviceusestatement,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Deviceusestatement), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.deviceusestatement_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn diagnosticreport_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Diagnosticreport, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn diagnosticreport_search(
  search_for search_args: r4b_sansio.SpDiagnosticreport,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Diagnosticreport), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.diagnosticreport_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn documentmanifest_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Documentmanifest, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn documentmanifest_search(
  search_for search_args: r4b_sansio.SpDocumentmanifest,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Documentmanifest), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.documentmanifest_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn documentreference_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Documentreference, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn documentreference_search(
  search_for search_args: r4b_sansio.SpDocumentreference,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Documentreference), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.documentreference_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn encounter_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Encounter, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn encounter_search(
  search_for search_args: r4b_sansio.SpEncounter,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Encounter), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.encounter_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn endpoint_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Endpoint, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn endpoint_search(
  search_for search_args: r4b_sansio.SpEndpoint,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Endpoint), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.endpoint_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn enrollmentrequest_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Enrollmentrequest, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn enrollmentrequest_search(
  search_for search_args: r4b_sansio.SpEnrollmentrequest,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Enrollmentrequest), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.enrollmentrequest_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn enrollmentresponse_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Enrollmentresponse, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn enrollmentresponse_search(
  search_for search_args: r4b_sansio.SpEnrollmentresponse,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Enrollmentresponse), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.enrollmentresponse_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn episodeofcare_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Episodeofcare, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn episodeofcare_search(
  search_for search_args: r4b_sansio.SpEpisodeofcare,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Episodeofcare), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.episodeofcare_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn eventdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Eventdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn eventdefinition_search(
  search_for search_args: r4b_sansio.SpEventdefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Eventdefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.eventdefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn evidence_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Evidence, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn evidence_search(
  search_for search_args: r4b_sansio.SpEvidence,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Evidence), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.evidence_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn evidencereport_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Evidencereport, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn evidencereport_search(
  search_for search_args: r4b_sansio.SpEvidencereport,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Evidencereport), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.evidencereport_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn evidencevariable_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Evidencevariable, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn evidencevariable_search(
  search_for search_args: r4b_sansio.SpEvidencevariable,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Evidencevariable), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.evidencevariable_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn examplescenario_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Examplescenario, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn examplescenario_search(
  search_for search_args: r4b_sansio.SpExamplescenario,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Examplescenario), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.examplescenario_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn explanationofbenefit_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Explanationofbenefit, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn explanationofbenefit_search(
  search_for search_args: r4b_sansio.SpExplanationofbenefit,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Explanationofbenefit), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.explanationofbenefit_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn familymemberhistory_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Familymemberhistory, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn familymemberhistory_search(
  search_for search_args: r4b_sansio.SpFamilymemberhistory,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Familymemberhistory), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.familymemberhistory_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn flag_create(
  resource: r4b.Flag,
  client: FhirClient,
  handle_response: fn(Result(r4b.Flag, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn flag_search(
  search_for search_args: r4b_sansio.SpFlag,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Flag), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.flag_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn goal_create(
  resource: r4b.Goal,
  client: FhirClient,
  handle_response: fn(Result(r4b.Goal, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn goal_search(
  search_for search_args: r4b_sansio.SpGoal,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Goal), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.goal_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn graphdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Graphdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn graphdefinition_search(
  search_for search_args: r4b_sansio.SpGraphdefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Graphdefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.graphdefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn group_create(
  resource: r4b.Group,
  client: FhirClient,
  handle_response: fn(Result(r4b.Group, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn group_search(
  search_for search_args: r4b_sansio.SpGroup,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Group), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.group_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn guidanceresponse_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Guidanceresponse, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn guidanceresponse_search(
  search_for search_args: r4b_sansio.SpGuidanceresponse,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Guidanceresponse), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.guidanceresponse_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn healthcareservice_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Healthcareservice, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn healthcareservice_search(
  search_for search_args: r4b_sansio.SpHealthcareservice,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Healthcareservice), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.healthcareservice_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn imagingstudy_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Imagingstudy, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn imagingstudy_search(
  search_for search_args: r4b_sansio.SpImagingstudy,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Imagingstudy), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.imagingstudy_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn immunization_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Immunization, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn immunization_search(
  search_for search_args: r4b_sansio.SpImmunization,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Immunization), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.immunization_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn immunizationevaluation_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Immunizationevaluation, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn immunizationrecommendation_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Immunizationrecommendation, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn implementationguide_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Implementationguide, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn implementationguide_search(
  search_for search_args: r4b_sansio.SpImplementationguide,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Implementationguide), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.implementationguide_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn ingredient_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Ingredient, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn ingredient_search(
  search_for search_args: r4b_sansio.SpIngredient,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Ingredient), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.ingredient_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn insuranceplan_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Insuranceplan, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn insuranceplan_search(
  search_for search_args: r4b_sansio.SpInsuranceplan,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Insuranceplan), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.insuranceplan_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn invoice_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Invoice, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn invoice_search(
  search_for search_args: r4b_sansio.SpInvoice,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Invoice), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.invoice_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn library_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Library, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn library_search(
  search_for search_args: r4b_sansio.SpLibrary,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Library), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.library_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn linkage_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Linkage, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn linkage_search(
  search_for search_args: r4b_sansio.SpLinkage,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Linkage), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.linkage_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn listfhir_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Listfhir, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn listfhir_search(
  search_for search_args: r4b_sansio.SpListfhir,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Listfhir), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.listfhir_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn location_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Location, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn location_search(
  search_for search_args: r4b_sansio.SpLocation,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Location), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.location_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn manufactureditemdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Manufactureditemdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn measure_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Measure, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn measure_search(
  search_for search_args: r4b_sansio.SpMeasure,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Measure), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.measure_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn measurereport_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Measurereport, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn measurereport_search(
  search_for search_args: r4b_sansio.SpMeasurereport,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Measurereport), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.measurereport_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn media_create(
  resource: r4b.Media,
  client: FhirClient,
  handle_response: fn(Result(r4b.Media, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn media_search(
  search_for search_args: r4b_sansio.SpMedia,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Media), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.media_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn medication_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Medication, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn medication_search(
  search_for search_args: r4b_sansio.SpMedication,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Medication), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.medication_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn medicationadministration_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Medicationadministration, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn medicationdispense_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Medicationdispense, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn medicationdispense_search(
  search_for search_args: r4b_sansio.SpMedicationdispense,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Medicationdispense), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.medicationdispense_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn medicationknowledge_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Medicationknowledge, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn medicationknowledge_search(
  search_for search_args: r4b_sansio.SpMedicationknowledge,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Medicationknowledge), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.medicationknowledge_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn medicationrequest_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Medicationrequest, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn medicationrequest_search(
  search_for search_args: r4b_sansio.SpMedicationrequest,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Medicationrequest), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.medicationrequest_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn medicationstatement_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Medicationstatement, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn medicationstatement_search(
  search_for search_args: r4b_sansio.SpMedicationstatement,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Medicationstatement), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.medicationstatement_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn medicinalproductdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Medicinalproductdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn messagedefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Messagedefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn messagedefinition_search(
  search_for search_args: r4b_sansio.SpMessagedefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Messagedefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.messagedefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn messageheader_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Messageheader, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn messageheader_search(
  search_for search_args: r4b_sansio.SpMessageheader,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Messageheader), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.messageheader_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn molecularsequence_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Molecularsequence, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn molecularsequence_search(
  search_for search_args: r4b_sansio.SpMolecularsequence,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Molecularsequence), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.molecularsequence_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn namingsystem_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Namingsystem, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn namingsystem_search(
  search_for search_args: r4b_sansio.SpNamingsystem,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Namingsystem), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.namingsystem_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn nutritionorder_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Nutritionorder, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn nutritionorder_search(
  search_for search_args: r4b_sansio.SpNutritionorder,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Nutritionorder), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.nutritionorder_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn nutritionproduct_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Nutritionproduct, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn nutritionproduct_search(
  search_for search_args: r4b_sansio.SpNutritionproduct,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Nutritionproduct), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.nutritionproduct_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn observation_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Observation, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn observation_search(
  search_for search_args: r4b_sansio.SpObservation,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Observation), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.observation_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn observationdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Observationdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn observationdefinition_search(
  search_for search_args: r4b_sansio.SpObservationdefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Observationdefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.observationdefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn operationdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Operationdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn operationdefinition_search(
  search_for search_args: r4b_sansio.SpOperationdefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Operationdefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.operationdefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn operationoutcome_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Operationoutcome, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn operationoutcome_search(
  search_for search_args: r4b_sansio.SpOperationoutcome,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Operationoutcome), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.operationoutcome_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn organization_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Organization, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn organization_search(
  search_for search_args: r4b_sansio.SpOrganization,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Organization), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.organization_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn organizationaffiliation_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Organizationaffiliation, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn packagedproductdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Packagedproductdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn patient_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Patient, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn patient_search(
  search_for search_args: r4b_sansio.SpPatient,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Patient), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.patient_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn paymentnotice_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Paymentnotice, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn paymentnotice_search(
  search_for search_args: r4b_sansio.SpPaymentnotice,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Paymentnotice), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.paymentnotice_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn paymentreconciliation_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Paymentreconciliation, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn paymentreconciliation_search(
  search_for search_args: r4b_sansio.SpPaymentreconciliation,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Paymentreconciliation), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.paymentreconciliation_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn person_create(
  resource: r4b.Person,
  client: FhirClient,
  handle_response: fn(Result(r4b.Person, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn person_search(
  search_for search_args: r4b_sansio.SpPerson,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Person), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.person_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn plandefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Plandefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn plandefinition_search(
  search_for search_args: r4b_sansio.SpPlandefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Plandefinition), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.plandefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn practitioner_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Practitioner, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn practitioner_search(
  search_for search_args: r4b_sansio.SpPractitioner,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Practitioner), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.practitioner_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn practitionerrole_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Practitionerrole, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn practitionerrole_search(
  search_for search_args: r4b_sansio.SpPractitionerrole,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Practitionerrole), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.practitionerrole_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn procedure_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Procedure, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn procedure_search(
  search_for search_args: r4b_sansio.SpProcedure,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Procedure), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.procedure_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn provenance_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Provenance, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn provenance_search(
  search_for search_args: r4b_sansio.SpProvenance,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Provenance), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.provenance_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn questionnaire_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Questionnaire, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn questionnaire_search(
  search_for search_args: r4b_sansio.SpQuestionnaire,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Questionnaire), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.questionnaire_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn questionnaireresponse_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Questionnaireresponse, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn questionnaireresponse_search(
  search_for search_args: r4b_sansio.SpQuestionnaireresponse,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Questionnaireresponse), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.questionnaireresponse_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn regulatedauthorization_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Regulatedauthorization, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn relatedperson_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Relatedperson, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn relatedperson_search(
  search_for search_args: r4b_sansio.SpRelatedperson,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Relatedperson), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.relatedperson_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn requestgroup_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Requestgroup, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn requestgroup_search(
  search_for search_args: r4b_sansio.SpRequestgroup,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Requestgroup), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.requestgroup_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn researchdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Researchdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn researchdefinition_search(
  search_for search_args: r4b_sansio.SpResearchdefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Researchdefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.researchdefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn researchelementdefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Researchelementdefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn researchstudy_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Researchstudy, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn researchstudy_search(
  search_for search_args: r4b_sansio.SpResearchstudy,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Researchstudy), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.researchstudy_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn researchsubject_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Researchsubject, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn researchsubject_search(
  search_for search_args: r4b_sansio.SpResearchsubject,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Researchsubject), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.researchsubject_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn riskassessment_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Riskassessment, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn riskassessment_search(
  search_for search_args: r4b_sansio.SpRiskassessment,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Riskassessment), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.riskassessment_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn schedule_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Schedule, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn schedule_search(
  search_for search_args: r4b_sansio.SpSchedule,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Schedule), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.schedule_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn searchparameter_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Searchparameter, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn searchparameter_search(
  search_for search_args: r4b_sansio.SpSearchparameter,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Searchparameter), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.searchparameter_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn servicerequest_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Servicerequest, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn servicerequest_search(
  search_for search_args: r4b_sansio.SpServicerequest,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Servicerequest), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.servicerequest_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn slot_create(
  resource: r4b.Slot,
  client: FhirClient,
  handle_response: fn(Result(r4b.Slot, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn slot_search(
  search_for search_args: r4b_sansio.SpSlot,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Slot), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.slot_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn specimen_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Specimen, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn specimen_search(
  search_for search_args: r4b_sansio.SpSpecimen,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Specimen), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.specimen_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn specimendefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Specimendefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn specimendefinition_search(
  search_for search_args: r4b_sansio.SpSpecimendefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Specimendefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.specimendefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn structuredefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Structuredefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn structuredefinition_search(
  search_for search_args: r4b_sansio.SpStructuredefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Structuredefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.structuredefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn structuremap_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Structuremap, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn structuremap_search(
  search_for search_args: r4b_sansio.SpStructuremap,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Structuremap), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.structuremap_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn subscription_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Subscription, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn subscription_search(
  search_for search_args: r4b_sansio.SpSubscription,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Subscription), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.subscription_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn subscriptionstatus_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Subscriptionstatus, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn subscriptionstatus_search(
  search_for search_args: r4b_sansio.SpSubscriptionstatus,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Subscriptionstatus), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.subscriptionstatus_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn subscriptiontopic_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Subscriptiontopic, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn subscriptiontopic_search(
  search_for search_args: r4b_sansio.SpSubscriptiontopic,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Subscriptiontopic), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.subscriptiontopic_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn substance_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Substance, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn substance_search(
  search_for search_args: r4b_sansio.SpSubstance,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Substance), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.substance_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn substancedefinition_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Substancedefinition, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn substancedefinition_search(
  search_for search_args: r4b_sansio.SpSubstancedefinition,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Substancedefinition), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.substancedefinition_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn supplydelivery_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Supplydelivery, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn supplydelivery_search(
  search_for search_args: r4b_sansio.SpSupplydelivery,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Supplydelivery), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.supplydelivery_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn supplyrequest_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Supplyrequest, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn supplyrequest_search(
  search_for search_args: r4b_sansio.SpSupplyrequest,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Supplyrequest), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.supplyrequest_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn task_create(
  resource: r4b.Task,
  client: FhirClient,
  handle_response: fn(Result(r4b.Task, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn task_search(
  search_for search_args: r4b_sansio.SpTask,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Task), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.task_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn terminologycapabilities_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Terminologycapabilities, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn testreport_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Testreport, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn testreport_search(
  search_for search_args: r4b_sansio.SpTestreport,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Testreport), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.testreport_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn testscript_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Testscript, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn testscript_search(
  search_for search_args: r4b_sansio.SpTestscript,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Testscript), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.testscript_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn valueset_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Valueset, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn valueset_search(
  search_for search_args: r4b_sansio.SpValueset,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Valueset), Err)) -> msg,
) -> Effect(msg) {
  let req = r4b_sansio.valueset_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
    req,
...
pub fn verificationresult_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Verificationresult, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn verificationresult_search(
  search_for search_args: r4b_sansio.SpVerificationresult,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Verificationresult), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.verificationresult_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
...
pub fn visionprescription_create(
  ...
  client: FhirClient,
  handle_response: fn(Result(r4b.Visionprescription, Err)) -> a,
) -> Effect(a) {
  any_create(
...
pub fn visionprescription_search(
  search_for search_args: r4b_sansio.SpVisionprescription,
  with_client client: FhirClient,
  response_msg handle_response: fn(Result(List(r4b.Visionprescription), Err)) ->
    msg,
) -> Effect(msg) {
  let req = r4b_sansio.visionprescription_search_req(search_args, client)
  sendreq_handleresponse_andprocess(
