...
pub fn search_any(
  ...
  sendreq_handleresponse(req, r4usp.bundle_decoder(), handle_response)
}
...
fn sendreq_handleresponse_andprocess(
  ...
  let handle_read = fn(resp_res: Result(Response(String), rsvp.Error)) {
    handle_response(case resp_res {
      ...
      Ok(resp_res) -> {
        case r4usp_sansio.any_resp(resp_res, res_dec) {
...
pub fn account_delete(
  ...
  any_delete(resource.id.value, "Account", client, handle_response)
}
...
pub fn activitydefinition_delete(
  ...
  any_delete(resource.id.value, "ActivityDefinition", client, handle_response)
}
...
pub fn adverseevent_delete(
  ...
  any_delete(resource.id.value, "AdverseEvent", client, handle_response)
}
...
pub fn allergyintolerance_delete(
  ...
  any_delete(resource.id.value, "AllergyIntolerance", client, handle_response)
}
...
pub fn appointment_delete(
  ...
  any_delete(resource.id.value, "Appointment", client, handle_response)
}
...
pub fn appointmentresponse_delete(
  ...
  any_delete(resource.id.value, "AppointmentResponse", client, handle_response)
}
...
pub fn auditevent_delete(
  ...
  any_delete(resource.id.value, "AuditEvent", client, handle_response)
}
...
pub fn basic_delete(
  ...
  any_delete(resource.id.value, "Basic", client, handle_response)
}
...
pub fn binary_delete(
  ...
  any_delete(resource.id.value, "Binary", client, handle_response)
}
...
pub fn bodystructure_delete(
  ...
  any_delete(resource.id.value, "BodyStructure", client, handle_response)
}
...
pub fn bundle_delete(
  ...
  any_delete(resource.id.value, "Bundle", client, handle_response)
}
...
pub fn capabilitystatement_delete(
  ...
  any_delete(resource.id.value, "CapabilityStatement", client, handle_response)
}
...
pub fn careplan_delete(
  ...
  any_delete(resource.id.value, "CarePlan", client, handle_response)
}
...
pub fn careteam_delete(
  ...
  any_delete(resource.id.value, "CareTeam", client, handle_response)
}
...
pub fn catalogentry_delete(
  ...
  any_delete(resource.id.value, "CatalogEntry", client, handle_response)
}
...
pub fn chargeitem_delete(
  ...
  any_delete(resource.id.value, "ChargeItem", client, handle_response)
}
...
pub fn chargeitemdefinition_delete(
  ...
  any_delete(resource.id.value, "ChargeItemDefinition", client, handle_response)
}
...
pub fn claim_delete(
  ...
  any_delete(resource.id.value, "Claim", client, handle_response)
}
...
pub fn claimresponse_delete(
  ...
  any_delete(resource.id.value, "ClaimResponse", client, handle_response)
}
...
pub fn clinicalimpression_delete(
  ...
  any_delete(resource.id.value, "ClinicalImpression", client, handle_response)
}
...
pub fn codesystem_delete(
  ...
  any_delete(resource.id.value, "CodeSystem", client, handle_response)
}
...
pub fn communication_delete(
  ...
  any_delete(resource.id.value, "Communication", client, handle_response)
}
...
pub fn communicationrequest_delete(
  ...
  any_delete(resource.id.value, "CommunicationRequest", client, handle_response)
}
...
pub fn composition_delete(
  ...
  any_delete(resource.id.value, "Composition", client, handle_response)
}
...
pub fn conceptmap_delete(
  ...
  any_delete(resource.id.value, "ConceptMap", client, handle_response)
}
...
pub fn condition_delete(
  ...
  any_delete(resource.id.value, "Condition", client, handle_response)
}
...
pub fn consent_delete(
  ...
  any_delete(resource.id.value, "Consent", client, handle_response)
}
...
pub fn contract_delete(
  ...
  any_delete(resource.id.value, "Contract", client, handle_response)
}
...
pub fn coverage_delete(
  ...
  any_delete(resource.id.value, "Coverage", client, handle_response)
}
...
pub fn detectedissue_delete(
  ...
  any_delete(resource.id.value, "DetectedIssue", client, handle_response)
}
...
pub fn device_delete(
  ...
  any_delete(resource.id.value, "Device", client, handle_response)
}
...
pub fn devicedefinition_delete(
  ...
  any_delete(resource.id.value, "DeviceDefinition", client, handle_response)
}
...
pub fn devicemetric_delete(
  ...
  any_delete(resource.id.value, "DeviceMetric", client, handle_response)
}
...
pub fn devicerequest_delete(
  ...
  any_delete(resource.id.value, "DeviceRequest", client, handle_response)
}
...
pub fn deviceusestatement_delete(
  ...
  any_delete(resource.id.value, "DeviceUseStatement", client, handle_response)
}
...
pub fn diagnosticreport_delete(
  ...
  any_delete(resource.id.value, "DiagnosticReport", client, handle_response)
}
...
pub fn documentmanifest_delete(
  ...
  any_delete(resource.id.value, "DocumentManifest", client, handle_response)
}
...
pub fn documentreference_delete(
  ...
  any_delete(resource.id.value, "DocumentReference", client, handle_response)
}
...
pub fn encounter_delete(
  ...
  any_delete(resource.id.value, "Encounter", client, handle_response)
}
...
pub fn endpoint_delete(
  ...
  any_delete(resource.id.value, "Endpoint", client, handle_response)
}
...
pub fn enrollmentrequest_delete(
  ...
  any_delete(resource.id.value, "EnrollmentRequest", client, handle_response)
}
...
pub fn enrollmentresponse_delete(
  ...
  any_delete(resource.id.value, "EnrollmentResponse", client, handle_response)
}
...
pub fn episodeofcare_delete(
  ...
  any_delete(resource.id.value, "EpisodeOfCare", client, handle_response)
}
...
pub fn eventdefinition_delete(
  ...
  any_delete(resource.id.value, "EventDefinition", client, handle_response)
}
...
pub fn evidence_delete(
  ...
  any_delete(resource.id.value, "Evidence", client, handle_response)
}
...
pub fn evidencevariable_delete(
  ...
  any_delete(resource.id.value, "EvidenceVariable", client, handle_response)
}
...
pub fn examplescenario_delete(
  ...
  any_delete(resource.id.value, "ExampleScenario", client, handle_response)
}
...
pub fn explanationofbenefit_delete(
  ...
  any_delete(resource.id.value, "ExplanationOfBenefit", client, handle_response)
}
...
pub fn familymemberhistory_delete(
  ...
  any_delete(resource.id.value, "FamilyMemberHistory", client, handle_response)
}
...
pub fn flag_delete(
  ...
  any_delete(resource.id.value, "Flag", client, handle_response)
}
...
pub fn goal_delete(
  ...
  any_delete(resource.id.value, "Goal", client, handle_response)
}
...
pub fn graphdefinition_delete(
  ...
  any_delete(resource.id.value, "GraphDefinition", client, handle_response)
}
...
pub fn group_delete(
  ...
  any_delete(resource.id.value, "Group", client, handle_response)
}
...
pub fn guidanceresponse_delete(
  ...
  any_delete(resource.id.value, "GuidanceResponse", client, handle_response)
}
...
pub fn healthcareservice_delete(
  ...
  any_delete(resource.id.value, "HealthcareService", client, handle_response)
}
...
pub fn imagingstudy_delete(
  ...
  any_delete(resource.id.value, "ImagingStudy", client, handle_response)
}
...
pub fn immunization_delete(
  ...
  any_delete(resource.id.value, "Immunization", client, handle_response)
}
...
pub fn implementationguide_delete(
  ...
  any_delete(resource.id.value, "ImplementationGuide", client, handle_response)
}
...
pub fn insuranceplan_delete(
  ...
  any_delete(resource.id.value, "InsurancePlan", client, handle_response)
}
...
pub fn invoice_delete(
  ...
  any_delete(resource.id.value, "Invoice", client, handle_response)
}
...
pub fn library_delete(
  ...
  any_delete(resource.id.value, "Library", client, handle_response)
}
...
pub fn linkage_delete(
  ...
  any_delete(resource.id.value, "Linkage", client, handle_response)
}
...
pub fn listfhir_delete(
  ...
  any_delete(resource.id.value, "List", client, handle_response)
}
...
pub fn location_delete(
  ...
  any_delete(resource.id.value, "Location", client, handle_response)
}
...
pub fn measure_delete(
  ...
  any_delete(resource.id.value, "Measure", client, handle_response)
}
...
pub fn measurereport_delete(
  ...
  any_delete(resource.id.value, "MeasureReport", client, handle_response)
}
...
pub fn media_delete(
  ...
  any_delete(resource.id.value, "Media", client, handle_response)
}
...
pub fn medication_delete(
  ...
  any_delete(resource.id.value, "Medication", client, handle_response)
}
...
pub fn medicationdispense_delete(
  ...
  any_delete(resource.id.value, "MedicationDispense", client, handle_response)
}
...
pub fn medicationknowledge_delete(
  ...
  any_delete(resource.id.value, "MedicationKnowledge", client, handle_response)
}
...
pub fn medicationrequest_delete(
  ...
  any_delete(resource.id.value, "MedicationRequest", client, handle_response)
}
...
pub fn medicationstatement_delete(
  ...
  any_delete(resource.id.value, "MedicationStatement", client, handle_response)
}
...
pub fn medicinalproduct_delete(
  ...
  any_delete(resource.id.value, "MedicinalProduct", client, handle_response)
}
...
pub fn messagedefinition_delete(
  ...
  any_delete(resource.id.value, "MessageDefinition", client, handle_response)
}
...
pub fn messageheader_delete(
  ...
  any_delete(resource.id.value, "MessageHeader", client, handle_response)
}
...
pub fn molecularsequence_delete(
  ...
  any_delete(resource.id.value, "MolecularSequence", client, handle_response)
}
...
pub fn namingsystem_delete(
  ...
  any_delete(resource.id.value, "NamingSystem", client, handle_response)
}
...
pub fn nutritionorder_delete(
  ...
  any_delete(resource.id.value, "NutritionOrder", client, handle_response)
}
...
pub fn observation_delete(
  ...
  any_delete(resource.id.value, "Observation", client, handle_response)
}
...
pub fn operationdefinition_delete(
  ...
  any_delete(resource.id.value, "OperationDefinition", client, handle_response)
}
...
pub fn operationoutcome_delete(
  ...
  any_delete(resource.id.value, "OperationOutcome", client, handle_response)
}
...
pub fn organization_delete(
  ...
  any_delete(resource.id.value, "Organization", client, handle_response)
}
...
pub fn patient_delete(
  ...
  any_delete(resource.id.value, "Patient", client, handle_response)
}
...
pub fn paymentnotice_delete(
  ...
  any_delete(resource.id.value, "PaymentNotice", client, handle_response)
}
...
pub fn person_delete(
  ...
  any_delete(resource.id.value, "Person", client, handle_response)
}
...
pub fn plandefinition_delete(
  ...
  any_delete(resource.id.value, "PlanDefinition", client, handle_response)
}
...
pub fn practitioner_delete(
  ...
  any_delete(resource.id.value, "Practitioner", client, handle_response)
}
...
pub fn practitionerrole_delete(
  ...
  any_delete(resource.id.value, "PractitionerRole", client, handle_response)
}
...
pub fn procedure_delete(
  ...
  any_delete(resource.id.value, "Procedure", client, handle_response)
}
...
pub fn provenance_delete(
  ...
  any_delete(resource.id.value, "Provenance", client, handle_response)
}
...
pub fn questionnaire_delete(
  ...
  any_delete(resource.id.value, "Questionnaire", client, handle_response)
}
...
pub fn relatedperson_delete(
  ...
  any_delete(resource.id.value, "RelatedPerson", client, handle_response)
}
...
pub fn requestgroup_delete(
  ...
  any_delete(resource.id.value, "RequestGroup", client, handle_response)
}
...
pub fn researchdefinition_delete(
  ...
  any_delete(resource.id.value, "ResearchDefinition", client, handle_response)
}
...
pub fn researchstudy_delete(
  ...
  any_delete(resource.id.value, "ResearchStudy", client, handle_response)
}
...
pub fn researchsubject_delete(
  ...
  any_delete(resource.id.value, "ResearchSubject", client, handle_response)
}
...
pub fn riskassessment_delete(
  ...
  any_delete(resource.id.value, "RiskAssessment", client, handle_response)
}
...
pub fn schedule_delete(
  ...
  any_delete(resource.id.value, "Schedule", client, handle_response)
}
...
pub fn searchparameter_delete(
  ...
  any_delete(resource.id.value, "SearchParameter", client, handle_response)
}
...
pub fn servicerequest_delete(
  ...
  any_delete(resource.id.value, "ServiceRequest", client, handle_response)
}
...
pub fn slot_delete(
  ...
  any_delete(resource.id.value, "Slot", client, handle_response)
}
...
pub fn specimen_delete(
  ...
  any_delete(resource.id.value, "Specimen", client, handle_response)
}
...
pub fn specimendefinition_delete(
  ...
  any_delete(resource.id.value, "SpecimenDefinition", client, handle_response)
}
...
pub fn structuredefinition_delete(
  ...
  any_delete(resource.id.value, "StructureDefinition", client, handle_response)
}
...
pub fn structuremap_delete(
  ...
  any_delete(resource.id.value, "StructureMap", client, handle_response)
}
...
pub fn subscription_delete(
  ...
  any_delete(resource.id.value, "Subscription", client, handle_response)
}
...
pub fn substance_delete(
  ...
  any_delete(resource.id.value, "Substance", client, handle_response)
}
...
pub fn substancenucleicacid_delete(
  ...
  any_delete(resource.id.value, "SubstanceNucleicAcid", client, handle_response)
}
...
pub fn substancepolymer_delete(
  ...
  any_delete(resource.id.value, "SubstancePolymer", client, handle_response)
}
...
pub fn substanceprotein_delete(
  ...
  any_delete(resource.id.value, "SubstanceProtein", client, handle_response)
}
...
pub fn supplydelivery_delete(
  ...
  any_delete(resource.id.value, "SupplyDelivery", client, handle_response)
}
...
pub fn supplyrequest_delete(
  ...
  any_delete(resource.id.value, "SupplyRequest", client, handle_response)
}
...
pub fn task_delete(
  ...
  any_delete(resource.id.value, "Task", client, handle_response)
}
...
pub fn testreport_delete(
  ...
  any_delete(resource.id.value, "TestReport", client, handle_response)
}
...
pub fn testscript_delete(
  ...
  any_delete(resource.id.value, "TestScript", client, handle_response)
}
...
pub fn valueset_delete(
  ...
  any_delete(resource.id.value, "ValueSet", client, handle_response)
}
...
pub fn verificationresult_delete(
  ...
  any_delete(resource.id.value, "VerificationResult", client, handle_response)
}
...
pub fn visionprescription_delete(
  ...
  any_delete(resource.id.value, "VisionPrescription", client, handle_response)
}
