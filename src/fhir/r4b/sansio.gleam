////[https://hl7.org/fhir/r4b](https://hl7.org/fhir/r4b) r4b sans-io request/response helpers suitable for building clients on top of, such as fhirclient_httpc.gleam and fhirclient_rsvp.gleam
...
///
/// `let assert Ok(client) = sansio.fhirclient_new("r4b.smarthealthit.org/")`
///
/// `let assert Ok(client) = sansio.fhirclient_new("https://r4b.smarthealthit.org/")`
///
/// `let assert Ok(client) = sansio.fhirclient_new("https://hapi.fhir.org/baser4b")`
///
