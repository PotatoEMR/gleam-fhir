...
pub type Conceptmapunmappedmode{ConceptmapunmappedmodeUsesourcecode
...
pub fn conceptmapunmappedmode_to_json(conceptmapunmappedmode: Conceptmapunmappedmode) -> Json {
    case conceptmapunmappedmode {ConceptmapunmappedmodeUsesourcecode -> json.string("use-source-code")
...
ConceptmapunmappedmodeOthermap -> json.string("other-map")
  ...
  pub fn conceptmapunmappedmode_decoder() -> Decoder(Conceptmapunmappedmode) {
    use variant <- decode.then(decode.string)
    case variant {"use-source-code" -> decode.success(ConceptmapunmappedmodeUsesourcecode)
"fixed" -> decode.success(ConceptmapunmappedmodeFixed)
"other-map" -> decode.success(ConceptmapunmappedmodeOthermap)
_ -> decode.failure(ConceptmapunmappedmodeUsesourcecode, "Conceptmapunmappedmode")}
  }
...
pub type Additionalbindingpurpose{AdditionalbindingpurposeMaximum
...
pub fn additionalbindingpurpose_to_json(additionalbindingpurpose: Additionalbindingpurpose) -> Json {
    case additionalbindingpurpose {AdditionalbindingpurposeMaximum -> json.string("maximum")
...
AdditionalbindingpurposeComponent -> json.string("component")
  ...
  pub fn additionalbindingpurpose_decoder() -> Decoder(Additionalbindingpurpose) {
    use variant <- decode.then(decode.string)
    case variant {"maximum" -> decode.success(AdditionalbindingpurposeMaximum)
...
_ -> decode.failure(AdditionalbindingpurposeMaximum, "Additionalbindingpurpose")}
  }
  
pub type Detectedissuestatus{DetectedissuestatusPreliminary
DetectedissuestatusFinal
DetectedissuestatusEnteredinerror
DetectedissuestatusMitigated
}
pub fn detectedissuestatus_to_json(detectedissuestatus: Detectedissuestatus) -> Json {
    case detectedissuestatus {DetectedissuestatusPreliminary -> json.string("preliminary")
...
DetectedissuestatusMitigated -> json.string("mitigated")
  ...
  pub fn detectedissuestatus_decoder() -> Decoder(Detectedissuestatus) {
    use variant <- decode.then(decode.string)
    case variant {"preliminary" -> decode.success(DetectedissuestatusPreliminary)
...
pub type Resourcetypes{ResourcetypesAccount
...
pub fn resourcetypes_to_json(resourcetypes: Resourcetypes) -> Json {
    case resourcetypes {ResourcetypesAccount -> json.string("Account")
ResourcetypesActivitydefinition -> json.string("ActivityDefinition")
ResourcetypesActordefinition -> json.string("ActorDefinition")
ResourcetypesAdministrableproductdefinition -> json.string("AdministrableProductDefinition")
...
ResourcetypesBiologicallyderivedproduct -> json.string("BiologicallyDerivedProduct")
ResourcetypesBiologicallyderivedproductdispense -> json.string("BiologicallyDerivedProductDispense")
...
ResourcetypesCoverageeligibilityrequest -> json.string("CoverageEligibilityRequest")
ResourcetypesCoverageeligibilityresponse -> json.string("CoverageEligibilityResponse")
...
ResourcetypesImmunizationrecommendation -> json.string("ImmunizationRecommendation")
...
ResourcetypesManufactureditemdefinition -> json.string("ManufacturedItemDefinition")
...
ResourcetypesMedicationadministration -> json.string("MedicationAdministration")
...
ResourcetypesMedicinalproductdefinition -> json.string("MedicinalProductDefinition")
...
ResourcetypesOrganizationaffiliation -> json.string("OrganizationAffiliation")
ResourcetypesPackagedproductdefinition -> json.string("PackagedProductDefinition")
...
ResourcetypesSubstancereferenceinformation -> json.string("SubstanceReferenceInformation")
ResourcetypesSubstancesourcematerial -> json.string("SubstanceSourceMaterial")
...
ResourcetypesTerminologycapabilities -> json.string("TerminologyCapabilities")
...
ResourcetypesVisionprescription -> json.string("VisionPrescription")
  ...
  pub fn resourcetypes_decoder() -> Decoder(Resourcetypes) {
    use variant <- decode.then(decode.string)
    case variant {"Account" -> decode.success(ResourcetypesAccount)
...
"AdministrableProductDefinition" -> decode.success(ResourcetypesAdministrableproductdefinition)
...
"BiologicallyDerivedProduct" -> decode.success(ResourcetypesBiologicallyderivedproduct)
"BiologicallyDerivedProductDispense" -> decode.success(ResourcetypesBiologicallyderivedproductdispense)
...
"ClinicalUseDefinition" -> decode.success(ResourcetypesClinicalusedefinition)
...
"CompartmentDefinition" -> decode.success(ResourcetypesCompartmentdefinition)
...
"CoverageEligibilityRequest" -> decode.success(ResourcetypesCoverageeligibilityrequest)
"CoverageEligibilityResponse" -> decode.success(ResourcetypesCoverageeligibilityresponse)
...
"ImmunizationEvaluation" -> decode.success(ResourcetypesImmunizationevaluation)
"ImmunizationRecommendation" -> decode.success(ResourcetypesImmunizationrecommendation)
...
"ManufacturedItemDefinition" -> decode.success(ResourcetypesManufactureditemdefinition)
...
"MedicationAdministration" -> decode.success(ResourcetypesMedicationadministration)
...
"MedicinalProductDefinition" -> decode.success(ResourcetypesMedicinalproductdefinition)
...
"ObservationDefinition" -> decode.success(ResourcetypesObservationdefinition)
...
"OrganizationAffiliation" -> decode.success(ResourcetypesOrganizationaffiliation)
"PackagedProductDefinition" -> decode.success(ResourcetypesPackagedproductdefinition)
...
"PaymentReconciliation" -> decode.success(ResourcetypesPaymentreconciliation)
...
"QuestionnaireResponse" -> decode.success(ResourcetypesQuestionnaireresponse)
"RegulatedAuthorization" -> decode.success(ResourcetypesRegulatedauthorization)
...
"SubstanceReferenceInformation" -> decode.success(ResourcetypesSubstancereferenceinformation)
"SubstanceSourceMaterial" -> decode.success(ResourcetypesSubstancesourcematerial)
...
"TerminologyCapabilities" -> decode.success(ResourcetypesTerminologycapabilities)
...
pub type Inventoryitemstatus{InventoryitemstatusActive
InventoryitemstatusInactive
InventoryitemstatusEnteredinerror
InventoryitemstatusUnknown
}
pub fn inventoryitemstatus_to_json(inventoryitemstatus: Inventoryitemstatus) -> Json {
    case inventoryitemstatus {InventoryitemstatusActive -> json.string("active")
...
InventoryitemstatusUnknown -> json.string("unknown")
  ...
  pub fn inventoryitemstatus_decoder() -> Decoder(Inventoryitemstatus) {
    use variant <- decode.then(decode.string)
    case variant {"active" -> decode.success(InventoryitemstatusActive)
...
pub type Devicenametype{DevicenametypeRegisteredname
...
pub fn devicenametype_to_json(devicenametype: Devicenametype) -> Json {
    case devicenametype {DevicenametypeRegisteredname -> json.string("registered-name")
...
DevicenametypePatientreportedname -> json.string("patient-reported-name")
  ...
  pub fn devicenametype_decoder() -> Decoder(Devicenametype) {
    use variant <- decode.then(decode.string)
    case variant {"registered-name" -> decode.success(DevicenametypeRegisteredname)
...
pub type Conditionquestionnairepurpose{ConditionquestionnairepurposePreadmit
ConditionquestionnairepurposeDiffdiagnosis
ConditionquestionnairepurposeOutcome
}
pub fn conditionquestionnairepurpose_to_json(conditionquestionnairepurpose: Conditionquestionnairepurpose) -> Json {
    case conditionquestionnairepurpose {ConditionquestionnairepurposePreadmit -> json.string("preadmit")
...
ConditionquestionnairepurposeOutcome -> json.string("outcome")
  ...
  pub fn conditionquestionnairepurpose_decoder() -> Decoder(Conditionquestionnairepurpose) {
    use variant <- decode.then(decode.string)
    case variant {"preadmit" -> decode.success(ConditionquestionnairepurposePreadmit)
"diff-diagnosis" -> decode.success(ConditionquestionnairepurposeDiffdiagnosis)
"outcome" -> decode.success(ConditionquestionnairepurposeOutcome)
_ -> decode.failure(ConditionquestionnairepurposePreadmit, "Conditionquestionnairepurpose")}
  }
  
pub type Genomicstudystatus{GenomicstudystatusRegistered
GenomicstudystatusAvailable
GenomicstudystatusCancelled
GenomicstudystatusEnteredinerror
GenomicstudystatusUnknown
}
pub fn genomicstudystatus_to_json(genomicstudystatus: Genomicstudystatus) -> Json {
    case genomicstudystatus {GenomicstudystatusRegistered -> json.string("registered")
...
GenomicstudystatusUnknown -> json.string("unknown")
  ...
  pub fn genomicstudystatus_decoder() -> Decoder(Genomicstudystatus) {
    use variant <- decode.then(decode.string)
    case variant {"registered" -> decode.success(GenomicstudystatusRegistered)
...
pub type Enrollmentoutcome{EnrollmentoutcomeQueued
...
pub fn enrollmentoutcome_to_json(enrollmentoutcome: Enrollmentoutcome) -> Json {
    case enrollmentoutcome {EnrollmentoutcomeQueued -> json.string("queued")
...
EnrollmentoutcomePartial -> json.string("partial")
  ...
  pub fn enrollmentoutcome_decoder() -> Decoder(Enrollmentoutcome) {
    use variant <- decode.then(decode.string)
    case variant {"queued" -> decode.success(EnrollmentoutcomeQueued)
...
PaymentoutcomePartial -> json.string("partial")
  ...
  pub fn paymentoutcome_decoder() -> Decoder(Paymentoutcome) {
    use variant <- decode.then(decode.string)
    case variant {"queued" -> decode.success(PaymentoutcomeQueued)
...
pub type Inventoryreportcounttype{InventoryreportcounttypeSnapshot
InventoryreportcounttypeDifference
}
pub fn inventoryreportcounttype_to_json(inventoryreportcounttype: Inventoryreportcounttype) -> Json {
    case inventoryreportcounttype {InventoryreportcounttypeSnapshot -> json.string("snapshot")
InventoryreportcounttypeDifference -> json.string("difference")
  ...
  pub fn inventoryreportcounttype_decoder() -> Decoder(Inventoryreportcounttype) {
    use variant <- decode.then(decode.string)
    case variant {"snapshot" -> decode.success(InventoryreportcounttypeSnapshot)
"difference" -> decode.success(InventoryreportcounttypeDifference)
_ -> decode.failure(InventoryreportcounttypeSnapshot, "Inventoryreportcounttype")}
  }
...
pub type Assertmanualcompletioncodes{AssertmanualcompletioncodesFail
AssertmanualcompletioncodesPass
AssertmanualcompletioncodesSkip
AssertmanualcompletioncodesStop
}
pub fn assertmanualcompletioncodes_to_json(assertmanualcompletioncodes: Assertmanualcompletioncodes) -> Json {
    case assertmanualcompletioncodes {AssertmanualcompletioncodesFail -> json.string("fail")
...
AssertmanualcompletioncodesStop -> json.string("stop")
  ...
  pub fn assertmanualcompletioncodes_decoder() -> Decoder(Assertmanualcompletioncodes) {
    use variant <- decode.then(decode.string)
    case variant {"fail" -> decode.success(AssertmanualcompletioncodesFail)
...
_ -> decode.failure(AssertmanualcompletioncodesFail, "Assertmanualcompletioncodes")}
  }
...
pub type Devicecorrectiveactionscope{DevicecorrectiveactionscopeModel
DevicecorrectiveactionscopeLotnumbers
DevicecorrectiveactionscopeSerialnumbers
}
pub fn devicecorrectiveactionscope_to_json(devicecorrectiveactionscope: Devicecorrectiveactionscope) -> Json {
    case devicecorrectiveactionscope {DevicecorrectiveactionscopeModel -> json.string("model")
...
DevicecorrectiveactionscopeSerialnumbers -> json.string("serial-numbers")
  ...
  pub fn devicecorrectiveactionscope_decoder() -> Decoder(Devicecorrectiveactionscope) {
    use variant <- decode.then(decode.string)
    case variant {"model" -> decode.success(DevicecorrectiveactionscopeModel)
...
_ -> decode.failure(DevicecorrectiveactionscopeModel, "Devicecorrectiveactionscope")}
  }
...
BundletypeSubscriptionnotification -> json.string("subscription-notification")
}
  }
...
"subscription-notification" -> decode.success(BundletypeSubscriptionnotification)
...
pub type Provenanceentityrole{ProvenanceentityroleRevision
...
pub fn provenanceentityrole_to_json(provenanceentityrole: Provenanceentityrole) -> Json {
    case provenanceentityrole {ProvenanceentityroleRevision -> json.string("revision")
...
ProvenanceentityroleRemoval -> json.string("removal")
  ...
  pub fn provenanceentityrole_decoder() -> Decoder(Provenanceentityrole) {
    use variant <- decode.then(decode.string)
    case variant {"revision" -> decode.success(ProvenanceentityroleRevision)
...
pub type Eligibilityoutcome{EligibilityoutcomeQueued
EligibilityoutcomeComplete
EligibilityoutcomeError
EligibilityoutcomePartial
}
pub fn eligibilityoutcome_to_json(eligibilityoutcome: Eligibilityoutcome) -> Json {
    case eligibilityoutcome {EligibilityoutcomeQueued -> json.string("queued")
...
EligibilityoutcomePartial -> json.string("partial")
  ...
  pub fn eligibilityoutcome_decoder() -> Decoder(Eligibilityoutcome) {
    use variant <- decode.then(decode.string)
    case variant {"queued" -> decode.success(EligibilityoutcomeQueued)
...
pub type Valuefiltercomparator{ValuefiltercomparatorEq
...
pub fn valuefiltercomparator_to_json(valuefiltercomparator: Valuefiltercomparator) -> Json {
    case valuefiltercomparator {ValuefiltercomparatorEq -> json.string("eq")
...
ValuefiltercomparatorEb -> json.string("eb")
  ...
  pub fn valuefiltercomparator_decoder() -> Decoder(Valuefiltercomparator) {
    use variant <- decode.then(decode.string)
    case variant {"eq" -> decode.success(ValuefiltercomparatorEq)
...
RequestresourcetypesCoverageeligibilityrequest -> json.string("CoverageEligibilityRequest")
...
RequestresourcetypesRequestorchestration -> json.string("RequestOrchestration")
...
"CoverageEligibilityRequest" -> decode.success(RequestresourcetypesCoverageeligibilityrequest)
...
"RequestOrchestration" -> decode.success(RequestresourcetypesRequestorchestration)
...
pub type Claimoutcome{ClaimoutcomeQueued
ClaimoutcomeComplete
ClaimoutcomeError
ClaimoutcomePartial
}
pub fn claimoutcome_to_json(claimoutcome: Claimoutcome) -> Json {
    case claimoutcome {ClaimoutcomeQueued -> json.string("queued")
...
ClaimoutcomePartial -> json.string("partial")
  ...
  pub fn claimoutcome_decoder() -> Decoder(Claimoutcome) {
    use variant <- decode.then(decode.string)
    case variant {"queued" -> decode.success(ClaimoutcomeQueued)
...
pub type Groupmembershipbasis{GroupmembershipbasisDefinitional
GroupmembershipbasisEnumerated
}
pub fn groupmembershipbasis_to_json(groupmembershipbasis: Groupmembershipbasis) -> Json {
    case groupmembershipbasis {GroupmembershipbasisDefinitional -> json.string("definitional")
GroupmembershipbasisEnumerated -> json.string("enumerated")
}
  }
  pub fn groupmembershipbasis_decoder() -> Decoder(Groupmembershipbasis) {
    use variant <- decode.then(decode.string)
    case variant {"definitional" -> decode.success(GroupmembershipbasisDefinitional)
"enumerated" -> decode.success(GroupmembershipbasisEnumerated)
_ -> decode.failure(GroupmembershipbasisDefinitional, "Groupmembershipbasis")}
  }
...
pub type Auditeventseverity{AuditeventseverityEmergency
...
pub fn auditeventseverity_to_json(auditeventseverity: Auditeventseverity) -> Json {
    case auditeventseverity {AuditeventseverityEmergency -> json.string("emergency")
...
AuditeventseverityDebug -> json.string("debug")
  ...
  pub fn auditeventseverity_decoder() -> Decoder(Auditeventseverity) {
    use variant <- decode.then(decode.string)
    case variant {"emergency" -> decode.success(AuditeventseverityEmergency)
...
pub type Questionnaireanswerconstraint{QuestionnaireanswerconstraintOptionsonly
QuestionnaireanswerconstraintOptionsortype
QuestionnaireanswerconstraintOptionsorstring
}
pub fn questionnaireanswerconstraint_to_json(questionnaireanswerconstraint: Questionnaireanswerconstraint) -> Json {
    case questionnaireanswerconstraint {QuestionnaireanswerconstraintOptionsonly -> json.string("optionsOnly")
QuestionnaireanswerconstraintOptionsortype -> json.string("optionsOrType")
QuestionnaireanswerconstraintOptionsorstring -> json.string("optionsOrString")
}
  }
  pub fn questionnaireanswerconstraint_decoder() -> Decoder(Questionnaireanswerconstraint) {
    use variant <- decode.then(decode.string)
    case variant {"optionsOnly" -> decode.success(QuestionnaireanswerconstraintOptionsonly)
"optionsOrType" -> decode.success(QuestionnaireanswerconstraintOptionsortype)
"optionsOrString" -> decode.success(QuestionnaireanswerconstraintOptionsorstring)
_ -> decode.failure(QuestionnaireanswerconstraintOptionsonly, "Questionnaireanswerconstraint")}
  }
...
pub type Conditionpreconditiontype{ConditionpreconditiontypeSensitive
ConditionpreconditiontypeSpecific
}
pub fn conditionpreconditiontype_to_json(conditionpreconditiontype: Conditionpreconditiontype) -> Json {
    case conditionpreconditiontype {ConditionpreconditiontypeSensitive -> json.string("sensitive")
ConditionpreconditiontypeSpecific -> json.string("specific")
  ...
  pub fn conditionpreconditiontype_decoder() -> Decoder(Conditionpreconditiontype) {
    use variant <- decode.then(decode.string)
    case variant {"sensitive" -> decode.success(ConditionpreconditiontypeSensitive)
"specific" -> decode.success(ConditionpreconditiontypeSpecific)
_ -> decode.failure(ConditionpreconditiontypeSensitive, "Conditionpreconditiontype")}
  }
...
pub type Conceptmappropertytype{ConceptmappropertytypeCoding
...
pub fn conceptmappropertytype_to_json(conceptmappropertytype: Conceptmappropertytype) -> Json {
    case conceptmappropertytype {ConceptmappropertytypeCoding -> json.string("Coding")
...
ConceptmappropertytypeCode -> json.string("code")
  ...
  pub fn conceptmappropertytype_decoder() -> Decoder(Conceptmappropertytype) {
    use variant <- decode.then(decode.string)
    case variant {"Coding" -> decode.success(ConceptmappropertytypeCoding)
...
pub type Relatedartifacttypeall{RelatedartifacttypeallDocumentation
...
pub fn relatedartifacttypeall_to_json(relatedartifacttypeall: Relatedartifacttypeall) -> Json {
    case relatedartifacttypeall {RelatedartifacttypeallDocumentation -> json.string("documentation")
...
RelatedartifacttypeallReprintof -> json.string("reprint-of")
  ...
  pub fn relatedartifacttypeall_decoder() -> Decoder(Relatedartifacttypeall) {
    use variant <- decode.then(decode.string)
    case variant {"documentation" -> decode.success(RelatedartifacttypeallDocumentation)
...
_ -> decode.failure(RelatedartifacttypeallDocumentation, "Relatedartifacttypeall")}
  }
...
pub type Adverseeventstatus{AdverseeventstatusInprogress
AdverseeventstatusCompleted
AdverseeventstatusEnteredinerror
AdverseeventstatusUnknown
}
pub fn adverseeventstatus_to_json(adverseeventstatus: Adverseeventstatus) -> Json {
    case adverseeventstatus {AdverseeventstatusInprogress -> json.string("in-progress")
...
AdverseeventstatusUnknown -> json.string("unknown")
  ...
  pub fn adverseeventstatus_decoder() -> Decoder(Adverseeventstatus) {
    use variant <- decode.then(decode.string)
    case variant {"in-progress" -> decode.success(AdverseeventstatusInprogress)
...
pub type Coveragekind{CoveragekindInsurance
CoveragekindSelfpay
CoveragekindOther
}
pub fn coveragekind_to_json(coveragekind: Coveragekind) -> Json {
    case coveragekind {CoveragekindInsurance -> json.string("insurance")
...
CoveragekindOther -> json.string("other")
  ...
  pub fn coveragekind_decoder() -> Decoder(Coveragekind) {
    use variant <- decode.then(decode.string)
    case variant {"insurance" -> decode.success(CoveragekindInsurance)
...
pub type Submitdataupdatetype{SubmitdataupdatetypeIncremental
SubmitdataupdatetypeSnapshot
}
pub fn submitdataupdatetype_to_json(submitdataupdatetype: Submitdataupdatetype) -> Json {
    case submitdataupdatetype {SubmitdataupdatetypeIncremental -> json.string("incremental")
SubmitdataupdatetypeSnapshot -> json.string("snapshot")
}
  }
  pub fn submitdataupdatetype_decoder() -> Decoder(Submitdataupdatetype) {
    use variant <- decode.then(decode.string)
    case variant {"incremental" -> decode.success(SubmitdataupdatetypeIncremental)
...
pub type Imagingselectionstatus{ImagingselectionstatusAvailable
ImagingselectionstatusEnteredinerror
ImagingselectionstatusUnknown
}
pub fn imagingselectionstatus_to_json(imagingselectionstatus: Imagingselectionstatus) -> Json {
    case imagingselectionstatus {ImagingselectionstatusAvailable -> json.string("available")
...
ImagingselectionstatusUnknown -> json.string("unknown")
  ...
  pub fn imagingselectionstatus_decoder() -> Decoder(Imagingselectionstatus) {
    use variant <- decode.then(decode.string)
    case variant {"available" -> decode.success(ImagingselectionstatusAvailable)
"entered-in-error" -> decode.success(ImagingselectionstatusEnteredinerror)
"unknown" -> decode.success(ImagingselectionstatusUnknown)
_ -> decode.failure(ImagingselectionstatusAvailable, "Imagingselectionstatus")}
  }
...
pub type Operationparameterscope{OperationparameterscopeInstance
OperationparameterscopeType
OperationparameterscopeSystem
}
pub fn operationparameterscope_to_json(operationparameterscope: Operationparameterscope) -> Json {
    case operationparameterscope {OperationparameterscopeInstance -> json.string("instance")
...
OperationparameterscopeSystem -> json.string("system")
  ...
  pub fn operationparameterscope_decoder() -> Decoder(Operationparameterscope) {
    use variant <- decode.then(decode.string)
    case variant {"instance" -> decode.success(OperationparameterscopeInstance)
"type" -> decode.success(OperationparameterscopeType)
"system" -> decode.success(OperationparameterscopeSystem)
_ -> decode.failure(OperationparameterscopeInstance, "Operationparameterscope")}
  }
...
pub type Ianalinkrelations{IanalinkrelationsAbout
...
pub fn ianalinkrelations_to_json(ianalinkrelations: Ianalinkrelations) -> Json {
    case ianalinkrelations {IanalinkrelationsAbout -> json.string("about")
...
IanalinkrelationsAppletouchstartupimage -> json.string("apple-touch-startup-image")
...
IanalinkrelationsWorkingcopyof -> json.string("working-copy-of")
  ...
  pub fn ianalinkrelations_decoder() -> Decoder(Ianalinkrelations) {
    use variant <- decode.then(decode.string)
    case variant {"about" -> decode.success(IanalinkrelationsAbout)
...
"apple-touch-startup-image" -> decode.success(IanalinkrelationsAppletouchstartupimage)
...
"intervalOverlappedBy" -> decode.success(IanalinkrelationsIntervaloverlappedby)
...
pub type Searchprocessingmode{SearchprocessingmodeNormal
SearchprocessingmodePhonetic
SearchprocessingmodeOther
}
pub fn searchprocessingmode_to_json(searchprocessingmode: Searchprocessingmode) -> Json {
    case searchprocessingmode {SearchprocessingmodeNormal -> json.string("normal")
...
SearchprocessingmodeOther -> json.string("other")
  ...
  pub fn searchprocessingmode_decoder() -> Decoder(Searchprocessingmode) {
    use variant <- decode.then(decode.string)
    case variant {"normal" -> decode.success(SearchprocessingmodeNormal)
...
pub type Medicationstatementstatus{MedicationstatementstatusRecorded
...
pub fn medicationstatementstatus_to_json(medicationstatementstatus: Medicationstatementstatus) -> Json {
    case medicationstatementstatus {MedicationstatementstatusRecorded -> json.string("recorded")
...
MedicationstatementstatusDraft -> json.string("draft")
  ...
  pub fn medicationstatementstatus_decoder() -> Decoder(Medicationstatementstatus) {
    use variant <- decode.then(decode.string)
    case variant {"recorded" -> decode.success(MedicationstatementstatusRecorded)
...
_ -> decode.failure(MedicationstatementstatusRecorded, "Medicationstatementstatus")}
  }
  
pub type Codesearchsupport{CodesearchsupportIncompose
...
pub fn codesearchsupport_to_json(codesearchsupport: Codesearchsupport) -> Json {
    case codesearchsupport {CodesearchsupportIncompose -> json.string("in-compose")
CodesearchsupportInexpansion -> json.string("in-expansion")
CodesearchsupportIncomposeorexpansion -> json.string("in-compose-or-expansion")
}
  }
  pub fn codesearchsupport_decoder() -> Decoder(Codesearchsupport) {
    use variant <- decode.then(decode.string)
    case variant {"in-compose" -> decode.success(CodesearchsupportIncompose)
"in-expansion" -> decode.success(CodesearchsupportInexpansion)
"in-compose-or-expansion" -> decode.success(CodesearchsupportIncomposeorexpansion)
_ -> decode.failure(CodesearchsupportIncompose, "Codesearchsupport")}
  }
  
pub type Imagingselection2dgraphictype{Imagingselection2dgraphictypePoint
...
pub fn imagingselection2dgraphictype_to_json(imagingselection2dgraphictype: Imagingselection2dgraphictype) -> Json {
    case imagingselection2dgraphictype {Imagingselection2dgraphictypePoint -> json.string("point")
...
Imagingselection2dgraphictypeEllipse -> json.string("ellipse")
  ...
  pub fn imagingselection2dgraphictype_decoder() -> Decoder(Imagingselection2dgraphictype) {
    use variant <- decode.then(decode.string)
    case variant {"point" -> decode.success(Imagingselection2dgraphictypePoint)
...
_ -> decode.failure(Imagingselection2dgraphictypePoint, "Imagingselection2dgraphictype")}
  }
...
"electronic-transmission" -> decode.success(UdientrytypeElectronictransmission)
"unknown" -> decode.success(UdientrytypeUnknown)
_ -> decode.failure(UdientrytypeBarcode, "Udientrytype")}
  }
  
pub type Actionparticipanttype{ActionparticipanttypeCareteam
...
pub fn actionparticipanttype_to_json(actionparticipanttype: Actionparticipanttype) -> Json {
    case actionparticipanttype {ActionparticipanttypeCareteam -> json.string("careteam")
...
ActionparticipanttypeRelatedperson -> json.string("relatedperson")
  ...
  pub fn actionparticipanttype_decoder() -> Decoder(Actionparticipanttype) {
    use variant <- decode.then(decode.string)
    case variant {"careteam" -> decode.success(ActionparticipanttypeCareteam)
"device" -> decode.success(ActionparticipanttypeDevice)
"group" -> decode.success(ActionparticipanttypeGroup)
"healthcareservice" -> decode.success(ActionparticipanttypeHealthcareservice)
...
pub type Biologicallyderivedproductdispensestatus{BiologicallyderivedproductdispensestatusPreparation
...
pub fn biologicallyderivedproductdispensestatus_to_json(biologicallyderivedproductdispensestatus: Biologicallyderivedproductdispensestatus) -> Json {
    case biologicallyderivedproductdispensestatus {BiologicallyderivedproductdispensestatusPreparation -> json.string("preparation")
BiologicallyderivedproductdispensestatusInprogress -> json.string("in-progress")
BiologicallyderivedproductdispensestatusAllocated -> json.string("allocated")
BiologicallyderivedproductdispensestatusIssued -> json.string("issued")
BiologicallyderivedproductdispensestatusUnfulfilled -> json.string("unfulfilled")
BiologicallyderivedproductdispensestatusReturned -> json.string("returned")
BiologicallyderivedproductdispensestatusEnteredinerror -> json.string("entered-in-error")
BiologicallyderivedproductdispensestatusUnknown -> json.string("unknown")
}
  }
  pub fn biologicallyderivedproductdispensestatus_decoder() -> Decoder(Biologicallyderivedproductdispensestatus) {
    use variant <- decode.then(decode.string)
    case variant {"preparation" -> decode.success(BiologicallyderivedproductdispensestatusPreparation)
"in-progress" -> decode.success(BiologicallyderivedproductdispensestatusInprogress)
"allocated" -> decode.success(BiologicallyderivedproductdispensestatusAllocated)
"issued" -> decode.success(BiologicallyderivedproductdispensestatusIssued)
"unfulfilled" -> decode.success(BiologicallyderivedproductdispensestatusUnfulfilled)
"returned" -> decode.success(BiologicallyderivedproductdispensestatusReturned)
"entered-in-error" -> decode.success(BiologicallyderivedproductdispensestatusEnteredinerror)
"unknown" -> decode.success(BiologicallyderivedproductdispensestatusUnknown)
_ -> decode.failure(BiologicallyderivedproductdispensestatusPreparation, "Biologicallyderivedproductdispensestatus")}
  }
...
pub type Transportintent{TransportintentUnknown
...
pub fn transportintent_to_json(transportintent: Transportintent) -> Json {
    case transportintent {TransportintentUnknown -> json.string("unknown")
...
TransportintentOption -> json.string("option")
  ...
  pub fn transportintent_decoder() -> Decoder(Transportintent) {
    use variant <- decode.then(decode.string)
    case variant {"unknown" -> decode.success(TransportintentUnknown)
...
pub type Fhirtypes{FhirtypesBase
}
pub fn fhirtypes_to_json(fhirtypes: Fhirtypes) -> Json {
    case fhirtypes {FhirtypesBase -> json.string("Base")
}
  }
  pub fn fhirtypes_decoder() -> Decoder(Fhirtypes) {
    use variant <- decode.then(decode.string)
    case variant {"Base" -> decode.success(FhirtypesBase)
...
pub type Subscriptionpayloadcontent{SubscriptionpayloadcontentEmpty
SubscriptionpayloadcontentIdonly
SubscriptionpayloadcontentFullresource
}
pub fn subscriptionpayloadcontent_to_json(subscriptionpayloadcontent: Subscriptionpayloadcontent) -> Json {
    case subscriptionpayloadcontent {SubscriptionpayloadcontentEmpty -> json.string("empty")
SubscriptionpayloadcontentIdonly -> json.string("id-only")
SubscriptionpayloadcontentFullresource -> json.string("full-resource")
}
  }
  pub fn subscriptionpayloadcontent_decoder() -> Decoder(Subscriptionpayloadcontent) {
    use variant <- decode.then(decode.string)
    case variant {"empty" -> decode.success(SubscriptionpayloadcontentEmpty)
...
_ -> decode.failure(SubscriptionpayloadcontentEmpty, "Subscriptionpayloadcontent")}
  }
...
pub type Deviceproductidentifierinudi{DeviceproductidentifierinudiLotnumber
...
pub fn deviceproductidentifierinudi_to_json(deviceproductidentifierinudi: Deviceproductidentifierinudi) -> Json {
    case deviceproductidentifierinudi {DeviceproductidentifierinudiLotnumber -> json.string("lot-number")
DeviceproductidentifierinudiManufactureddate -> json.string("manufactured-date")
...
DeviceproductidentifierinudiBiologicalsource -> json.string("biological-source")
DeviceproductidentifierinudiSoftwareversion -> json.string("software-version")
}
  }
  pub fn deviceproductidentifierinudi_decoder() -> Decoder(Deviceproductidentifierinudi) {
    use variant <- decode.then(decode.string)
    case variant {"lot-number" -> decode.success(DeviceproductidentifierinudiLotnumber)
"manufactured-date" -> decode.success(DeviceproductidentifierinudiManufactureddate)
"serial-number" -> decode.success(DeviceproductidentifierinudiSerialnumber)
"expiration-date" -> decode.success(DeviceproductidentifierinudiExpirationdate)
"biological-source" -> decode.success(DeviceproductidentifierinudiBiologicalsource)
"software-version" -> decode.success(DeviceproductidentifierinudiSoftwareversion)
_ -> decode.failure(DeviceproductidentifierinudiLotnumber, "Deviceproductidentifierinudi")}
  }
...
pub type Imagingselection3dgraphictype{Imagingselection3dgraphictypePoint
...
pub fn imagingselection3dgraphictype_to_json(imagingselection3dgraphictype: Imagingselection3dgraphictype) -> Json {
    case imagingselection3dgraphictype {Imagingselection3dgraphictypePoint -> json.string("point")
...
Imagingselection3dgraphictypeEllipsoid -> json.string("ellipsoid")
  ...
  pub fn imagingselection3dgraphictype_decoder() -> Decoder(Imagingselection3dgraphictype) {
    use variant <- decode.then(decode.string)
    case variant {"point" -> decode.success(Imagingselection3dgraphictypePoint)
...
_ -> decode.failure(Imagingselection3dgraphictypePoint, "Imagingselection3dgraphictype")}
  }
...
pub type Artifactassessmentdisposition{ArtifactassessmentdispositionUnresolved
...
pub fn artifactassessmentdisposition_to_json(artifactassessmentdisposition: Artifactassessmentdisposition) -> Json {
    case artifactassessmentdisposition {ArtifactassessmentdispositionUnresolved -> json.string("unresolved")
...
ArtifactassessmentdispositionPersuasivewithmodification -> json.string("persuasive-with-modification")
ArtifactassessmentdispositionNotpersuasivewithmodification -> json.string("not-persuasive-with-modification")
}
  }
  pub fn artifactassessmentdisposition_decoder() -> Decoder(Artifactassessmentdisposition) {
    use variant <- decode.then(decode.string)
    case variant {"unresolved" -> decode.success(ArtifactassessmentdispositionUnresolved)
"not-persuasive" -> decode.success(ArtifactassessmentdispositionNotpersuasive)
"persuasive" -> decode.success(ArtifactassessmentdispositionPersuasive)
"persuasive-with-modification" -> decode.success(ArtifactassessmentdispositionPersuasivewithmodification)
"not-persuasive-with-modification" -> decode.success(ArtifactassessmentdispositionNotpersuasivewithmodification)
_ -> decode.failure(ArtifactassessmentdispositionUnresolved, "Artifactassessmentdisposition")}
  }
...
pub type Actionrelationshiptype{ActionrelationshiptypeBefore
...
pub fn actionrelationshiptype_to_json(actionrelationshiptype: Actionrelationshiptype) -> Json {
    case actionrelationshiptype {ActionrelationshiptypeBefore -> json.string("before")
...
ActionrelationshiptypeAfter -> json.string("after")
  ...
  pub fn actionrelationshiptype_decoder() -> Decoder(Actionrelationshiptype) {
    use variant <- decode.then(decode.string)
    case variant {"before" -> decode.success(ActionrelationshiptypeBefore)
...
pub type Questionnairedisableddisplay{QuestionnairedisableddisplayHidden
QuestionnairedisableddisplayProtected
}
pub fn questionnairedisableddisplay_to_json(questionnairedisableddisplay: Questionnairedisableddisplay) -> Json {
    case questionnairedisableddisplay {QuestionnairedisableddisplayHidden -> json.string("hidden")
QuestionnairedisableddisplayProtected -> json.string("protected")
}
  }
  pub fn questionnairedisableddisplay_decoder() -> Decoder(Questionnairedisableddisplay) {
    use variant <- decode.then(decode.string)
    case variant {"hidden" -> decode.success(QuestionnairedisableddisplayHidden)
"protected" -> decode.success(QuestionnairedisableddisplayProtected)
_ -> decode.failure(QuestionnairedisableddisplayHidden, "Questionnairedisableddisplay")}
  }
...
pub type Assertresponsecodetypes{AssertresponsecodetypesContinue
...
pub fn assertresponsecodetypes_to_json(assertresponsecodetypes: Assertresponsecodetypes) -> Json {
    case assertresponsecodetypes {AssertresponsecodetypesContinue -> json.string("continue")
AssertresponsecodetypesSwitchingprotocols -> json.string("switchingProtocols")
...
AssertresponsecodetypesNonauthoritativeinformation -> json.string("nonAuthoritativeInformation")
...
AssertresponsecodetypesProxyauthenticationrequired -> json.string("proxyAuthenticationRequired")
...
AssertresponsecodetypesUnsupportedmediatype -> json.string("unsupportedMediaType")
AssertresponsecodetypesRangenotsatisfiable -> json.string("rangeNotSatisfiable")
AssertresponsecodetypesExpectationfailed -> json.string("expectationFailed")
AssertresponsecodetypesMisdirectedrequest -> json.string("misdirectedRequest")
AssertresponsecodetypesUnprocessablecontent -> json.string("unprocessableContent")
AssertresponsecodetypesUpgraderequired -> json.string("upgradeRequired")
AssertresponsecodetypesInternalservererror -> json.string("internalServerError")
AssertresponsecodetypesNotimplemented -> json.string("notImplemented")
AssertresponsecodetypesBadgateway -> json.string("badGateway")
AssertresponsecodetypesServiceunavailable -> json.string("serviceUnavailable")
AssertresponsecodetypesGatewaytimeout -> json.string("gatewayTimeout")
AssertresponsecodetypesHttpversionnotsupported -> json.string("httpVersionNotSupported")
}
  }
  pub fn assertresponsecodetypes_decoder() -> Decoder(Assertresponsecodetypes) {
    use variant <- decode.then(decode.string)
    case variant {"continue" -> decode.success(AssertresponsecodetypesContinue)
"switchingProtocols" -> decode.success(AssertresponsecodetypesSwitchingprotocols)
...
"nonAuthoritativeInformation" -> decode.success(AssertresponsecodetypesNonauthoritativeinformation)
...
"movedPermanently" -> decode.success(AssertresponsecodetypesMovedpermanently)
...
"temporaryRedirect" -> decode.success(AssertresponsecodetypesTemporaryredirect)
"permanentRedirect" -> decode.success(AssertresponsecodetypesPermanentredirect)
...
"proxyAuthenticationRequired" -> decode.success(AssertresponsecodetypesProxyauthenticationrequired)
...
"unsupportedMediaType" -> decode.success(AssertresponsecodetypesUnsupportedmediatype)
"rangeNotSatisfiable" -> decode.success(AssertresponsecodetypesRangenotsatisfiable)
"expectationFailed" -> decode.success(AssertresponsecodetypesExpectationfailed)
"misdirectedRequest" -> decode.success(AssertresponsecodetypesMisdirectedrequest)
"unprocessableContent" -> decode.success(AssertresponsecodetypesUnprocessablecontent)
"upgradeRequired" -> decode.success(AssertresponsecodetypesUpgraderequired)
"internalServerError" -> decode.success(AssertresponsecodetypesInternalservererror)
...
"serviceUnavailable" -> decode.success(AssertresponsecodetypesServiceunavailable)
"gatewayTimeout" -> decode.success(AssertresponsecodetypesGatewaytimeout)
"httpVersionNotSupported" -> decode.success(AssertresponsecodetypesHttpversionnotsupported)
_ -> decode.failure(AssertresponsecodetypesContinue, "Assertresponsecodetypes")}
  }
...
pub type Graphcompartmentuse{GraphcompartmentuseWhere
GraphcompartmentuseRequires
}
pub fn graphcompartmentuse_to_json(graphcompartmentuse: Graphcompartmentuse) -> Json {
    case graphcompartmentuse {GraphcompartmentuseWhere -> json.string("where")
GraphcompartmentuseRequires -> json.string("requires")
}
  }
  pub fn graphcompartmentuse_decoder() -> Decoder(Graphcompartmentuse) {
    use variant <- decode.then(decode.string)
    case variant {"where" -> decode.success(GraphcompartmentuseWhere)
"requires" -> decode.success(GraphcompartmentuseRequires)
_ -> decode.failure(GraphcompartmentuseWhere, "Graphcompartmentuse")}
  }
  
pub type Observationtriggeredbytype{ObservationtriggeredbytypeReflex
ObservationtriggeredbytypeRepeat
ObservationtriggeredbytypeRerun
}
pub fn observationtriggeredbytype_to_json(observationtriggeredbytype: Observationtriggeredbytype) -> Json {
    case observationtriggeredbytype {ObservationtriggeredbytypeReflex -> json.string("reflex")
ObservationtriggeredbytypeRepeat -> json.string("repeat")
ObservationtriggeredbytypeRerun -> json.string("re-run")
}
  }
  pub fn observationtriggeredbytype_decoder() -> Decoder(Observationtriggeredbytype) {
    use variant <- decode.then(decode.string)
    case variant {"reflex" -> decode.success(ObservationtriggeredbytypeReflex)
"repeat" -> decode.success(ObservationtriggeredbytypeRepeat)
"re-run" -> decode.success(ObservationtriggeredbytypeRerun)
_ -> decode.failure(ObservationtriggeredbytypeReflex, "Observationtriggeredbytype")}
  }
  
pub type Permissionstatus{PermissionstatusActive
...
pub fn permissionstatus_to_json(permissionstatus: Permissionstatus) -> Json {
    case permissionstatus {PermissionstatusActive -> json.string("active")
...
PermissionstatusRejected -> json.string("rejected")
  ...
  pub fn permissionstatus_decoder() -> Decoder(Permissionstatus) {
    use variant <- decode.then(decode.string)
    case variant {"active" -> decode.success(PermissionstatusActive)
...
pub type Conceptmapattributetype{ConceptmapattributetypeCode
ConceptmapattributetypeCoding
ConceptmapattributetypeString
ConceptmapattributetypeBoolean
ConceptmapattributetypeQuantity
}
pub fn conceptmapattributetype_to_json(conceptmapattributetype: Conceptmapattributetype) -> Json {
    case conceptmapattributetype {ConceptmapattributetypeCode -> json.string("code")
...
ConceptmapattributetypeQuantity -> json.string("Quantity")
  ...
  pub fn conceptmapattributetype_decoder() -> Decoder(Conceptmapattributetype) {
    use variant <- decode.then(decode.string)
    case variant {"code" -> decode.success(ConceptmapattributetypeCode)
...
pub type Devicedispensestatus{DevicedispensestatusPreparation
...
pub fn devicedispensestatus_to_json(devicedispensestatus: Devicedispensestatus) -> Json {
    case devicedispensestatus {DevicedispensestatusPreparation -> json.string("preparation")
...
DevicedispensestatusUnknown -> json.string("unknown")
  ...
  pub fn devicedispensestatus_decoder() -> Decoder(Devicedispensestatus) {
    use variant <- decode.then(decode.string)
    case variant {"preparation" -> decode.success(DevicedispensestatusPreparation)
...
pub type Conceptmaprelationship{ConceptmaprelationshipRelatedto
ConceptmaprelationshipNotrelatedto
}
pub fn conceptmaprelationship_to_json(conceptmaprelationship: Conceptmaprelationship) -> Json {
    case conceptmaprelationship {ConceptmaprelationshipRelatedto -> json.string("related-to")
ConceptmaprelationshipNotrelatedto -> json.string("not-related-to")
  ...
  pub fn conceptmaprelationship_decoder() -> Decoder(Conceptmaprelationship) {
    use variant <- decode.then(decode.string)
    case variant {"related-to" -> decode.success(ConceptmaprelationshipRelatedto)
"not-related-to" -> decode.success(ConceptmaprelationshipNotrelatedto)
_ -> decode.failure(ConceptmaprelationshipRelatedto, "Conceptmaprelationship")}
  }
...
pub type Artifactassessmentinformationtype{ArtifactassessmentinformationtypeComment
...
pub fn artifactassessmentinformationtype_to_json(artifactassessmentinformationtype: Artifactassessmentinformationtype) -> Json {
    case artifactassessmentinformationtype {ArtifactassessmentinformationtypeComment -> json.string("comment")
...
ArtifactassessmentinformationtypeChangerequest -> json.string("change-request")
}
  }
  pub fn artifactassessmentinformationtype_decoder() -> Decoder(Artifactassessmentinformationtype) {
    use variant <- decode.then(decode.string)
    case variant {"comment" -> decode.success(ArtifactassessmentinformationtypeComment)
...
"change-request" -> decode.success(ArtifactassessmentinformationtypeChangerequest)
_ -> decode.failure(ArtifactassessmentinformationtypeComment, "Artifactassessmentinformationtype")}
  }
...
pub type Permissionrulecombining{PermissionrulecombiningDenyoverrides
...
pub fn permissionrulecombining_to_json(permissionrulecombining: Permissionrulecombining) -> Json {
    case permissionrulecombining {PermissionrulecombiningDenyoverrides -> json.string("deny-overrides")
PermissionrulecombiningPermitoverrides -> json.string("permit-overrides")
PermissionrulecombiningOrdereddenyoverrides -> json.string("ordered-deny-overrides")
PermissionrulecombiningOrderedpermitoverrides -> json.string("ordered-permit-overrides")
...
PermissionrulecombiningPermitunlessdeny -> json.string("permit-unless-deny")
  ...
  pub fn permissionrulecombining_decoder() -> Decoder(Permissionrulecombining) {
    use variant <- decode.then(decode.string)
    case variant {"deny-overrides" -> decode.success(PermissionrulecombiningDenyoverrides)
"permit-overrides" -> decode.success(PermissionrulecombiningPermitoverrides)
"ordered-deny-overrides" -> decode.success(PermissionrulecombiningOrdereddenyoverrides)
"ordered-permit-overrides" -> decode.success(PermissionrulecombiningOrderedpermitoverrides)
"deny-unless-permit" -> decode.success(PermissionrulecombiningDenyunlesspermit)
"permit-unless-deny" -> decode.success(PermissionrulecombiningPermitunlessdeny)
_ -> decode.failure(PermissionrulecombiningDenyoverrides, "Permissionrulecombining")}
  }
  
pub type Characteristiccombination{CharacteristiccombinationAllof
...
pub fn characteristiccombination_to_json(characteristiccombination: Characteristiccombination) -> Json {
    case characteristiccombination {CharacteristiccombinationAllof -> json.string("all-of")
...
CharacteristiccombinationDataset -> json.string("dataset")
  ...
  pub fn characteristiccombination_decoder() -> Decoder(Characteristiccombination) {
    use variant <- decode.then(decode.string)
    case variant {"all-of" -> decode.success(CharacteristiccombinationAllof)
...
_ -> decode.failure(CharacteristiccombinationAllof, "Characteristiccombination")}
  }
  
pub type Compositionstatus{CompositionstatusRegistered
...
pub fn compositionstatus_to_json(compositionstatus: Compositionstatus) -> Json {
    case compositionstatus {CompositionstatusRegistered -> json.string("registered")
...
CompositionstatusUnknown -> json.string("unknown")
  ...
  pub fn compositionstatus_decoder() -> Decoder(Compositionstatus) {
    use variant <- decode.then(decode.string)
    case variant {"registered" -> decode.success(CompositionstatusRegistered)
...
pub type Devicedefinitionregulatoryidentifiertype{DevicedefinitionregulatoryidentifiertypeBasic
DevicedefinitionregulatoryidentifiertypeMaster
DevicedefinitionregulatoryidentifiertypeLicense
}
pub fn devicedefinitionregulatoryidentifiertype_to_json(devicedefinitionregulatoryidentifiertype: Devicedefinitionregulatoryidentifiertype) -> Json {
    case devicedefinitionregulatoryidentifiertype {DevicedefinitionregulatoryidentifiertypeBasic -> json.string("basic")
...
DevicedefinitionregulatoryidentifiertypeLicense -> json.string("license")
  ...
  pub fn devicedefinitionregulatoryidentifiertype_decoder() -> Decoder(Devicedefinitionregulatoryidentifiertype) {
    use variant <- decode.then(decode.string)
    case variant {"basic" -> decode.success(DevicedefinitionregulatoryidentifiertypeBasic)
...
_ -> decode.failure(DevicedefinitionregulatoryidentifiertypeBasic, "Devicedefinitionregulatoryidentifiertype")}
  }
  
pub type Pricecomponenttype{PricecomponenttypeBase
...
pub fn pricecomponenttype_to_json(pricecomponenttype: Pricecomponenttype) -> Json {
    case pricecomponenttype {PricecomponenttypeBase -> json.string("base")
...
PricecomponenttypeInformational -> json.string("informational")
  ...
  pub fn pricecomponenttype_decoder() -> Decoder(Pricecomponenttype) {
    use variant <- decode.then(decode.string)
    case variant {"base" -> decode.success(PricecomponenttypeBase)
...
pub type Inventoryreportstatus{InventoryreportstatusDraft
InventoryreportstatusRequested
InventoryreportstatusActive
InventoryreportstatusEnteredinerror
}
pub fn inventoryreportstatus_to_json(inventoryreportstatus: Inventoryreportstatus) -> Json {
    case inventoryreportstatus {InventoryreportstatusDraft -> json.string("draft")
...
InventoryreportstatusEnteredinerror -> json.string("entered-in-error")
  ...
  pub fn inventoryreportstatus_decoder() -> Decoder(Inventoryreportstatus) {
    use variant <- decode.then(decode.string)
    case variant {"draft" -> decode.success(InventoryreportstatusDraft)
...
pub type Formularyitemstatus{FormularyitemstatusActive
FormularyitemstatusEnteredinerror
FormularyitemstatusInactive
}
pub fn formularyitemstatus_to_json(formularyitemstatus: Formularyitemstatus) -> Json {
    case formularyitemstatus {FormularyitemstatusActive -> json.string("active")
...
FormularyitemstatusInactive -> json.string("inactive")
  ...
  pub fn formularyitemstatus_decoder() -> Decoder(Formularyitemstatus) {
    use variant <- decode.then(decode.string)
    case variant {"active" -> decode.success(FormularyitemstatusActive)
...
pub type Transportstatus{TransportstatusInprogress
...
pub fn transportstatus_to_json(transportstatus: Transportstatus) -> Json {
    case transportstatus {TransportstatusInprogress -> json.string("in-progress")
...
TransportstatusEnteredinerror -> json.string("entered-in-error")
  ...
  pub fn transportstatus_decoder() -> Decoder(Transportstatus) {
    use variant <- decode.then(decode.string)
    case variant {"in-progress" -> decode.success(TransportstatusInprogress)
...
pub type Artifactassessmentworkflowstatus{ArtifactassessmentworkflowstatusSubmitted
...
pub fn artifactassessmentworkflowstatus_to_json(artifactassessmentworkflowstatus: Artifactassessmentworkflowstatus) -> Json {
    case artifactassessmentworkflowstatus {ArtifactassessmentworkflowstatusSubmitted -> json.string("submitted")
ArtifactassessmentworkflowstatusTriaged -> json.string("triaged")
ArtifactassessmentworkflowstatusWaitingforinput -> json.string("waiting-for-input")
ArtifactassessmentworkflowstatusResolvednochange -> json.string("resolved-no-change")
ArtifactassessmentworkflowstatusResolvedchangerequired -> json.string("resolved-change-required")
...
ArtifactassessmentworkflowstatusEnteredinerror -> json.string("entered-in-error")
}
  }
  pub fn artifactassessmentworkflowstatus_decoder() -> Decoder(Artifactassessmentworkflowstatus) {
    use variant <- decode.then(decode.string)
    case variant {"submitted" -> decode.success(ArtifactassessmentworkflowstatusSubmitted)
"triaged" -> decode.success(ArtifactassessmentworkflowstatusTriaged)
"waiting-for-input" -> decode.success(ArtifactassessmentworkflowstatusWaitingforinput)
"resolved-no-change" -> decode.success(ArtifactassessmentworkflowstatusResolvednochange)
"resolved-change-required" -> decode.success(ArtifactassessmentworkflowstatusResolvedchangerequired)
...
"entered-in-error" -> decode.success(ArtifactassessmentworkflowstatusEnteredinerror)
_ -> decode.failure(ArtifactassessmentworkflowstatusSubmitted, "Artifactassessmentworkflowstatus")}
  }
...
pub type Deviceusagestatus{DeviceusagestatusActive
...
pub fn deviceusagestatus_to_json(deviceusagestatus: Deviceusagestatus) -> Json {
    case deviceusagestatus {DeviceusagestatusActive -> json.string("active")
...
DeviceusagestatusOnhold -> json.string("on-hold")
  ...
  pub fn deviceusagestatus_decoder() -> Decoder(Deviceusagestatus) {
    use variant <- decode.then(decode.string)
    case variant {"active" -> decode.success(DeviceusagestatusActive)
...
pub type Appointmentresponsestatus{AppointmentresponsestatusAccepted
...
pub fn appointmentresponsestatus_to_json(appointmentresponsestatus: Appointmentresponsestatus) -> Json {
    case appointmentresponsestatus {AppointmentresponsestatusAccepted -> json.string("accepted")
...
AppointmentresponsestatusEnteredinerror -> json.string("entered-in-error")
  ...
  pub fn appointmentresponsestatus_decoder() -> Decoder(Appointmentresponsestatus) {
    use variant <- decode.then(decode.string)
    case variant {"accepted" -> decode.success(AppointmentresponsestatusAccepted)
...
"entered-in-error" -> decode.success(AppointmentresponsestatusEnteredinerror)
_ -> decode.failure(AppointmentresponsestatusAccepted, "Appointmentresponsestatus")}
  }
  
pub type Conformanceexpectation{ConformanceexpectationShall
ConformanceexpectationShould
ConformanceexpectationMay
ConformanceexpectationShouldnot
}
pub fn conformanceexpectation_to_json(conformanceexpectation: Conformanceexpectation) -> Json {
    case conformanceexpectation {ConformanceexpectationShall -> json.string("SHALL")
...
ConformanceexpectationShouldnot -> json.string("SHOULD-NOT")
  ...
  pub fn conformanceexpectation_decoder() -> Decoder(Conformanceexpectation) {
    use variant <- decode.then(decode.string)
    case variant {"SHALL" -> decode.success(ConformanceexpectationShall)
...
pub type Versionindependentallresourcetypes{VersionindependentallresourcetypesBodysite
...
pub fn versionindependentallresourcetypes_to_json(versionindependentallresourcetypes: Versionindependentallresourcetypes) -> Json {
    case versionindependentallresourcetypes {VersionindependentallresourcetypesBodysite -> json.string("BodySite")
VersionindependentallresourcetypesCatalogentry -> json.string("CatalogEntry")
...
VersionindependentallresourcetypesDevicecomponent -> json.string("DeviceComponent")
VersionindependentallresourcetypesDeviceuserequest -> json.string("DeviceUseRequest")
VersionindependentallresourcetypesDeviceusestatement -> json.string("DeviceUseStatement")
VersionindependentallresourcetypesDiagnosticorder -> json.string("DiagnosticOrder")
VersionindependentallresourcetypesDocumentmanifest -> json.string("DocumentManifest")
VersionindependentallresourcetypesEffectevidencesynthesis -> json.string("EffectEvidenceSynthesis")
VersionindependentallresourcetypesEligibilityrequest -> json.string("EligibilityRequest")
VersionindependentallresourcetypesEligibilityresponse -> json.string("EligibilityResponse")
VersionindependentallresourcetypesExpansionprofile -> json.string("ExpansionProfile")
VersionindependentallresourcetypesImagingmanifest -> json.string("ImagingManifest")
VersionindependentallresourcetypesImagingobjectselection -> json.string("ImagingObjectSelection")
VersionindependentallresourcetypesMedia -> json.string("Media")
VersionindependentallresourcetypesMedicationorder -> json.string("MedicationOrder")
VersionindependentallresourcetypesMedicationusage -> json.string("MedicationUsage")
VersionindependentallresourcetypesMedicinalproduct -> json.string("MedicinalProduct")
VersionindependentallresourcetypesMedicinalproductauthorization -> json.string("MedicinalProductAuthorization")
VersionindependentallresourcetypesMedicinalproductcontraindication -> json.string("MedicinalProductContraindication")
VersionindependentallresourcetypesMedicinalproductindication -> json.string("MedicinalProductIndication")
VersionindependentallresourcetypesMedicinalproductingredient -> json.string("MedicinalProductIngredient")
VersionindependentallresourcetypesMedicinalproductinteraction -> json.string("MedicinalProductInteraction")
VersionindependentallresourcetypesMedicinalproductmanufactured -> json.string("MedicinalProductManufactured")
VersionindependentallresourcetypesMedicinalproductpackaged -> json.string("MedicinalProductPackaged")
VersionindependentallresourcetypesMedicinalproductpharmaceutical -> json.string("MedicinalProductPharmaceutical")
VersionindependentallresourcetypesMedicinalproductundesirableeffect -> json.string("MedicinalProductUndesirableEffect")
VersionindependentallresourcetypesOrder -> json.string("Order")
VersionindependentallresourcetypesOrderresponse -> json.string("OrderResponse")
VersionindependentallresourcetypesProcedurerequest -> json.string("ProcedureRequest")
VersionindependentallresourcetypesProcessrequest -> json.string("ProcessRequest")
VersionindependentallresourcetypesProcessresponse -> json.string("ProcessResponse")
VersionindependentallresourcetypesReferralrequest -> json.string("ReferralRequest")
VersionindependentallresourcetypesRequestgroup -> json.string("RequestGroup")
VersionindependentallresourcetypesResearchdefinition -> json.string("ResearchDefinition")
VersionindependentallresourcetypesResearchelementdefinition -> json.string("ResearchElementDefinition")
VersionindependentallresourcetypesRiskevidencesynthesis -> json.string("RiskEvidenceSynthesis")
VersionindependentallresourcetypesSequence -> json.string("Sequence")
VersionindependentallresourcetypesServicedefinition -> json.string("ServiceDefinition")
VersionindependentallresourcetypesSubstancespecification -> json.string("SubstanceSpecification")
}
  }
  pub fn versionindependentallresourcetypes_decoder() -> Decoder(Versionindependentallresourcetypes) {
    use variant <- decode.then(decode.string)
    case variant {"BodySite" -> decode.success(VersionindependentallresourcetypesBodysite)
"CatalogEntry" -> decode.success(VersionindependentallresourcetypesCatalogentry)
"Conformance" -> decode.success(VersionindependentallresourcetypesConformance)
"DataElement" -> decode.success(VersionindependentallresourcetypesDataelement)
"DeviceComponent" -> decode.success(VersionindependentallresourcetypesDevicecomponent)
"DeviceUseRequest" -> decode.success(VersionindependentallresourcetypesDeviceuserequest)
"DeviceUseStatement" -> decode.success(VersionindependentallresourcetypesDeviceusestatement)
"DiagnosticOrder" -> decode.success(VersionindependentallresourcetypesDiagnosticorder)
"DocumentManifest" -> decode.success(VersionindependentallresourcetypesDocumentmanifest)
"EffectEvidenceSynthesis" -> decode.success(VersionindependentallresourcetypesEffectevidencesynthesis)
"EligibilityRequest" -> decode.success(VersionindependentallresourcetypesEligibilityrequest)
"EligibilityResponse" -> decode.success(VersionindependentallresourcetypesEligibilityresponse)
"ExpansionProfile" -> decode.success(VersionindependentallresourcetypesExpansionprofile)
"ImagingManifest" -> decode.success(VersionindependentallresourcetypesImagingmanifest)
"ImagingObjectSelection" -> decode.success(VersionindependentallresourcetypesImagingobjectselection)
"Media" -> decode.success(VersionindependentallresourcetypesMedia)
"MedicationOrder" -> decode.success(VersionindependentallresourcetypesMedicationorder)
"MedicationUsage" -> decode.success(VersionindependentallresourcetypesMedicationusage)
"MedicinalProduct" -> decode.success(VersionindependentallresourcetypesMedicinalproduct)
"MedicinalProductAuthorization" -> decode.success(VersionindependentallresourcetypesMedicinalproductauthorization)
"MedicinalProductContraindication" -> decode.success(VersionindependentallresourcetypesMedicinalproductcontraindication)
"MedicinalProductIndication" -> decode.success(VersionindependentallresourcetypesMedicinalproductindication)
"MedicinalProductIngredient" -> decode.success(VersionindependentallresourcetypesMedicinalproductingredient)
"MedicinalProductInteraction" -> decode.success(VersionindependentallresourcetypesMedicinalproductinteraction)
"MedicinalProductManufactured" -> decode.success(VersionindependentallresourcetypesMedicinalproductmanufactured)
"MedicinalProductPackaged" -> decode.success(VersionindependentallresourcetypesMedicinalproductpackaged)
"MedicinalProductPharmaceutical" -> decode.success(VersionindependentallresourcetypesMedicinalproductpharmaceutical)
"MedicinalProductUndesirableEffect" -> decode.success(VersionindependentallresourcetypesMedicinalproductundesirableeffect)
"Order" -> decode.success(VersionindependentallresourcetypesOrder)
"OrderResponse" -> decode.success(VersionindependentallresourcetypesOrderresponse)
"ProcedureRequest" -> decode.success(VersionindependentallresourcetypesProcedurerequest)
"ProcessRequest" -> decode.success(VersionindependentallresourcetypesProcessrequest)
"ProcessResponse" -> decode.success(VersionindependentallresourcetypesProcessresponse)
"ReferralRequest" -> decode.success(VersionindependentallresourcetypesReferralrequest)
"RequestGroup" -> decode.success(VersionindependentallresourcetypesRequestgroup)
"ResearchDefinition" -> decode.success(VersionindependentallresourcetypesResearchdefinition)
"ResearchElementDefinition" -> decode.success(VersionindependentallresourcetypesResearchelementdefinition)
"RiskEvidenceSynthesis" -> decode.success(VersionindependentallresourcetypesRiskevidencesynthesis)
"Sequence" -> decode.success(VersionindependentallresourcetypesSequence)
"ServiceDefinition" -> decode.success(VersionindependentallresourcetypesServicedefinition)
"SubstanceSpecification" -> decode.success(VersionindependentallresourcetypesSubstancespecification)
_ -> decode.failure(VersionindependentallresourcetypesBodysite, "Versionindependentallresourcetypes")}
  }
  
pub type Colorcodes{ColorcodesAliceblue
...
pub fn colorcodes_to_json(colorcodes: Colorcodes) -> Json {
    case colorcodes {ColorcodesAliceblue -> json.string("aliceblue")
...
ColorcodesYellowgreen -> json.string("yellowgreen")
  ...
  pub fn colorcodes_decoder() -> Decoder(Colorcodes) {
    use variant <- decode.then(decode.string)
    case variant {"aliceblue" -> decode.success(ColorcodesAliceblue)
