////[https://hl7.org/fhir/r4us](https://hl7.org/fhir/r4us) r4us sans-io request/response helpers suitable for building clients on top of, such as fhirclient_httpc.gleam and fhirclient_rsvp.gleam
...
///
/// `let assert Ok(client) = sansio.fhirclient_new("r4us.smarthealthit.org/")`
///
/// `let assert Ok(client) = sansio.fhirclient_new("https://r4us.smarthealthit.org/")`
///
/// `let assert Ok(client) = sansio.fhirclient_new("https://hapi.fhir.org/baser4us")`
///
