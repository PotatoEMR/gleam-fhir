////[https://hl7.org/fhir/r4usp](https://hl7.org/fhir/r4usp) r4usp sans-io request/response helpers suitable for building clients on top of, such as fhirclient_httpc.gleam and fhirclient_rsvp.gleam
...
///
/// `let assert Ok(client) = sansio.fhirclient_new("r4usp.smarthealthit.org/")`
///
/// `let assert Ok(client) = sansio.fhirclient_new("https://r4usp.smarthealthit.org/")`
///
/// `let assert Ok(client) = sansio.fhirclient_new("https://hapi.fhir.org/baser4usp")`
///
